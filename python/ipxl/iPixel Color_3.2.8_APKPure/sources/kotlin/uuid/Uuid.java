...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m3735boximpl(ULong.m3741constructorimpl(getMostSignificantBits())), ULong.m3735boximpl(ULong.m3741constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m5051toUByteArrayTcUX1vc() {
        return UByteArray.m3638constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m3741constructorimpl(j), ULong.m3741constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m3741constructorimpl(this.leastSignificantBits), ULong.m3741constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m5053fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m5052fromUByteArrayGBYM_sE(byte[] ubyteArray) {
