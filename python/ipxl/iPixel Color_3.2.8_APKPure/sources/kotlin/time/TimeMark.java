...
public interface TimeMark {
    ...
    TimeMark mo4905minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo4907plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m5026plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m5025minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo4907plusLRDsOJo(Duration.m4958unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m4940isNegativeimpl(timeMark.mo4904elapsedNowUwyO8pc());
        }
