...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo4905minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m5025minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo4904elapsedNowUwyO8pc() {
        return Duration.m4942minusLRDsOJo(this.mark.mo4904elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo4907plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m4943plusLRDsOJo(this.adjustment, duration), null);
    }
}
