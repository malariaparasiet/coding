...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m5028boximpl(m5022markNowz9LOYto());
    }
    ...
    public long m5022markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m5031constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m5021elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m5020differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m5019adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m5031constructorimpl(LongSaturatedMathKt.m5017saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
