...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m5012minusLRDsOJo(long duration) {
        return m5014plusLRDsOJo(Duration.m4958unaryMinusUwyO8pc(duration));
    }

    /* renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m5013minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m4943plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m5014plusLRDsOJo(long duration) {
        long m4928getInWholeSecondsimpl = Duration.m4928getInWholeSecondsimpl(duration);
        int m4930getNanosecondsComponentimpl = Duration.m4930getNanosecondsComponentimpl(duration);
        if (m4928getInWholeSecondsimpl == 0 && m4930getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + m4928getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (m4928getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + m4930getNanosecondsComponentimpl);
        }
        return Duration.m4941isPositiveimpl(duration) ? MAX : MIN;
    }
}
