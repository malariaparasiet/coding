...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m3656boximpl(m4801nextpVg5ArA());
    }
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m3662constructorimpl(i3);
    ...
    public int m4801nextpVg5ArA() {
        ...
        this.next = UInt.m3662constructorimpl(this.step + i);
        return i;
    }
}
