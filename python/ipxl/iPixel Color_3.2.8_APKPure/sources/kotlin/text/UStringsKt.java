...
public final class UStringsKt {
    ...
    public static final String m4901toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m4903toStringolVBNx4(short s, int i) {
    ...
    public static final String m4902toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m4900toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m3662constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m3579boximpl(UByte.m3585constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m3662constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m3842boximpl(UShort.m3848constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m3662constructorimpl = UInt.m3662constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = Integer.divideUnsigned(-1, m3662constructorimpl);
                    if (Integer.compareUnsigned(i3, i4) > 0) {
                    }
                }
                return null;
            }
            int m3662constructorimpl2 = UInt.m3662constructorimpl(i3 * m3662constructorimpl);
            int m3662constructorimpl3 = UInt.m3662constructorimpl(UInt.m3662constructorimpl(digitOf) + m3662constructorimpl2);
            if (Integer.compareUnsigned(m3662constructorimpl3, m3662constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = m3662constructorimpl3;
        }
        return UInt.m3656boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m3741constructorimpl = ULong.m3741constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = Long.divideUnsigned(-1L, m3741constructorimpl);
                    if (Long.compareUnsigned(j, j2) > 0) {
                    }
                }
                return null;
            }
            long m3741constructorimpl2 = ULong.m3741constructorimpl(j * m3741constructorimpl);
            long m3741constructorimpl3 = ULong.m3741constructorimpl(ULong.m3741constructorimpl(UInt.m3662constructorimpl(r13) & 4294967295L) + m3741constructorimpl2);
            if (Long.compareUnsigned(m3741constructorimpl3, m3741constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = m3741constructorimpl3;
        }
