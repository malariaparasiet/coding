...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, PlayerFinal.PLAYER_POSITION) { // from class: androidx.transition.ChangeBounds.5
