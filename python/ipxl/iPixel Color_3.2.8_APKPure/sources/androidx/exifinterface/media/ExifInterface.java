...
public class ExifInterface {
    ...
    static {
        ...
        ExifTag[] exifTagArr7 = {new ExifTag(TAG_ORF_PREVIEW_IMAGE_START, 257, 4), new ExifTag(TAG_ORF_PREVIEW_IMAGE_LENGTH, PlayerService.SEEK_CHANGE, 4)};
        ...
        SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat(DateUtils.TIME_FORMAT, Locale.US);
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(substring) || "-".equals(substring)) && ":".equals(str3.substring(3, 4)) && parseInt <= 14) {
                        int i2 = ((parseInt * 60) + parseInt2) * TimeConstants.MIN;
                        if (!"-".equals(substring)) {
                            i = -1;
                        }
                        time += i2 * i;
            ...
            if (i4 != 0) {
                ...
                if (Arrays.equals(bArr3, bArr4)) {
                    ...
                    if (Arrays.equals(bArr3, bArr7) || Arrays.equals(bArr3, WEBP_CHUNK_TYPE_VP8L)) {
                        ...
                        if (z) {
                            bArr10[0] = (byte) (bArr10[0] | JSONB.Constants.BC_INT32_NUM_16);
                        }
