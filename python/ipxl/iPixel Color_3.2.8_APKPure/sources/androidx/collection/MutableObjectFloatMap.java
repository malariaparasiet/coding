...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    private final void adjustStorage() {
        if (this._capacity > 8 && Long.compareUnsigned(ULong.m3741constructorimpl(ULong.m3741constructorimpl(this._size) * 32), ULong.m3741constructorimpl(ULong.m3741constructorimpl(this._capacity) * 25)) <= 0) {
