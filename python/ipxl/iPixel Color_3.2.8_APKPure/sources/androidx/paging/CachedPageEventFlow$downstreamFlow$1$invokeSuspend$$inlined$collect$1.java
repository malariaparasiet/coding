...
public final class CachedPageEventFlow$downstreamFlow$1$invokeSuspend$$inlined$collect$1<T> implements FlowCollector<IndexedValue<? extends PageEvent<T>>> {
    ...
    final /* synthetic */ Ref.IntRef $maxEventIndex$inlined;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    @DebugMetadata(c = "androidx.paging.CachedPageEventFlow$downstreamFlow$1$invokeSuspend$$inlined$collect$1", f = "CachedPageEventFlow.kt", i = {0, 0}, l = {Opcodes.L2I}, m = "emit", n = {"this", "indexedValue"}, s = {"L$0", "L$1"})
    ...
    public CachedPageEventFlow$downstreamFlow$1$invokeSuspend$$inlined$collect$1(Ref.IntRef intRef, FlowCollector flowCollector) {
        this.$maxEventIndex$inlined = intRef;
    ...
    */
    public java.lang.Object emit(kotlin.collections.IndexedValue<? extends androidx.paging.PageEvent<T>> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r4 = this;
        ...
        L3a:
            ...
            int r6 = r5.getIndex()
            kotlin.jvm.internal.Ref$IntRef r2 = r4.$maxEventIndex$inlined
            int r2 = r2.element
            if (r6 <= r2) goto L6b
            kotlinx.coroutines.flow.FlowCollector r6 = r4.$$this$flow$inlined
        ...
        L62:
            r0 = r4
        L63:
            kotlin.jvm.internal.Ref$IntRef r6 = r0.$maxEventIndex$inlined
            int r5 = r5.getIndex()
            r6.element = r5
        L6b:
