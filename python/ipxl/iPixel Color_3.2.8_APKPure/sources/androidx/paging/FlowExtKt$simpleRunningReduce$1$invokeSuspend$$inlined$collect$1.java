...
public final class FlowExtKt$simpleRunningReduce$1$invokeSuspend$$inlined$collect$1<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "androidx.paging.FlowExtKt$simpleRunningReduce$1$invokeSuspend$$inlined$collect$1", f = "FlowExt.kt", i = {0}, l = {Opcodes.F2I, Opcodes.D2I}, m = "emit", n = {"this"}, s = {"L$0"})
    ...
    */
    public java.lang.Object emit(T r8, kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        ...
        L69:
            r9.element = r8
            kotlinx.coroutines.flow.FlowCollector r8 = r2.$$this$flow$inlined
