...
public class CLContainer extends CLElement {
    ...
    @Override // androidx.constraintlayout.core.parser.CLElement
    /* renamed from: clone */
    public CLContainer mo2640clone() {
        CLContainer cLContainer = (CLContainer) super.mo2640clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement mo2640clone = it.next().mo2640clone();
            mo2640clone.setContainer(cLContainer);
            arrayList.add(mo2640clone);
        }
