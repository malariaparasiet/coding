...
class VirtualCameraAdapter implements UseCase.StateChangeCallback {
    ...
    Map<UseCase, OutConfig> getChildrenOutConfigs(SurfaceEdge surfaceEdge, int i, boolean z) {
        ...
        for (UseCase useCase : this.mChildren) {
            ...
            hashMap.put(useCase, calculateOutConfig(useCase, this.mResolutionsMerger, this.mParentCamera, surfaceEdge2, i, z));
    ...
    Map<UseCase, DualOutConfig> getChildrenOutConfigs(SurfaceEdge surfaceEdge, SurfaceEdge surfaceEdge2, int i, boolean z) {
        ...
        for (UseCase useCase : this.mChildren) {
            ...
            int i2 = i;
            boolean z2 = z;
            OutConfig calculateOutConfig = calculateOutConfig(useCase, this.mResolutionsMerger, this.mParentCamera, surfaceEdge3, i2, z2);
            SurfaceEdge surfaceEdge4 = surfaceEdge2;
            hashMap.put(useCase, DualOutConfig.of(calculateOutConfig, calculateOutConfig(useCase, this.mSecondaryResolutionsMerger, (CameraInternal) Objects.requireNonNull(this.mSecondaryParentCamera), surfaceEdge4, i2, z2)));
