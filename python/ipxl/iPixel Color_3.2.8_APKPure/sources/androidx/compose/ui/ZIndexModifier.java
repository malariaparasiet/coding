...
final class ZIndexModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo364measure3p2s80s(MeasureScope receiver, Measurable measurable, long j) {
        ...
        return MeasureScope.DefaultImpls.layout$default(receiver, mo1932measureBRTryo0.getWidth(), mo1932measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.ZIndexModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
