...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo363alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float m2550getWidthimpl = (IntSize.m2550getWidthimpl(space) - IntSize.m2550getWidthimpl(size)) / 2.0f;
        float m2549getHeightimpl = (IntSize.m2549getHeightimpl(space) - IntSize.m2549getHeightimpl(size)) / 2.0f;
        ...
        float f2 = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(m2550getWidthimpl * (f + f2)), MathKt.roundToInt(m2549getHeightimpl * (f2 + this.verticalBias)));
    }
