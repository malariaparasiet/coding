...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo363alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m2550getWidthimpl(space) - IntSize.m2550getWidthimpl(size), IntSize.m2549getHeightimpl(space) - IntSize.m2549getHeightimpl(size));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m2550getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m2549getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
