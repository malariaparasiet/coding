...
public final class ScaleFactor {
    ...
    public static final /* synthetic */ ScaleFactor m1981boximpl(long j) {
    ...
    public static int m1992hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m1988equalsimpl(getPackedValue(), obj);
    }

    public int hashCode() {
        return m1992hashCodeimpl(getPackedValue());
    }
    ...
    public static final float m1990getScaleXimpl(long j) {
        if (!(j != Unspecified)) {
    ...
    public static final float m1991getScaleYimpl(long j) {
        if (!(j != Unspecified)) {
            throw new IllegalStateException("ScaleFactor is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final float m1982component1impl(long j) {
        return m1990getScaleXimpl(j);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m1983component2impl(long j) {
        return m1991getScaleYimpl(j);
    }

    /* renamed from: copy-8GGzs04, reason: not valid java name */
    public static final long m1985copy8GGzs04(long j, float f, float f2) {
        return ScaleFactorKt.ScaleFactor(f, f2);
    }

    /* renamed from: copy-8GGzs04$default, reason: not valid java name */
    public static /* synthetic */ long m1986copy8GGzs04$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m1990getScaleXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m1991getScaleYimpl(j);
        }
        return m1985copy8GGzs04(j, f, f2);
    }

    /* renamed from: times-44nBxM0, reason: not valid java name */
    public static final long m1993times44nBxM0(long j, float f) {
        return ScaleFactorKt.ScaleFactor(m1990getScaleXimpl(j) * f, m1991getScaleYimpl(j) * f);
    }

    /* renamed from: div-44nBxM0, reason: not valid java name */
    public static final long m1987div44nBxM0(long j, float f) {
        return ScaleFactorKt.ScaleFactor(m1990getScaleXimpl(j) / f, m1991getScaleYimpl(j) / f);
    }
    ...
    public static String m1994toStringimpl(long j) {
        ...
        roundToTenths = ScaleFactorKt.roundToTenths(m1990getScaleXimpl(j));
        StringBuilder append = sb.append(roundToTenths).append(", ");
        roundToTenths2 = ScaleFactorKt.roundToTenths(m1991getScaleYimpl(j));
        return append.append(roundToTenths2).append(')').toString();
    }

    public String toString() {
        return m1994toStringimpl(getPackedValue());
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m1996getUnspecified_hLwfpc$annotations() {
        }
        ...
        public final long m1997getUnspecified_hLwfpc() {
