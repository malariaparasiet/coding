...
public interface ContentScale {
    ...
    long mo1923computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo1923computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m1929computeFillMaxDimensioniLBOSCw;
                m1929computeFillMaxDimensioniLBOSCw = ContentScaleKt.m1929computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m1929computeFillMaxDimensioniLBOSCw, m1929computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo1923computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m1930computeFillMinDimensioniLBOSCw;
                m1930computeFillMinDimensioniLBOSCw = ContentScaleKt.m1930computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m1930computeFillMinDimensioniLBOSCw, m1930computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo1923computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m1928computeFillHeightiLBOSCw;
                m1928computeFillHeightiLBOSCw = ContentScaleKt.m1928computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m1928computeFillHeightiLBOSCw, m1928computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo1923computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m1931computeFillWidthiLBOSCw;
                m1931computeFillWidthiLBOSCw = ContentScaleKt.m1931computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m1931computeFillWidthiLBOSCw, m1931computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo1923computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m1930computeFillMinDimensioniLBOSCw;
                if (Size.m511getWidthimpl(srcSize) > Size.m511getWidthimpl(dstSize) || Size.m508getHeightimpl(srcSize) > Size.m508getHeightimpl(dstSize)) {
                    m1930computeFillMinDimensioniLBOSCw = ContentScaleKt.m1930computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(m1930computeFillMinDimensioniLBOSCw, m1930computeFillMinDimensioniLBOSCw);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public long mo1923computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                m1931computeFillWidthiLBOSCw = ContentScaleKt.m1931computeFillWidthiLBOSCw(srcSize, dstSize);
                m1928computeFillHeightiLBOSCw = ContentScaleKt.m1928computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m1931computeFillWidthiLBOSCw, m1928computeFillHeightiLBOSCw);
            }
        };
