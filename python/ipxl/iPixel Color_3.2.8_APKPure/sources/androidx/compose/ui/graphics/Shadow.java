...
public final class Shadow {
    ...
    public static /* synthetic */ void m918getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m919getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m458getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m672equalsimpl0(getColor(), shadow.getColor()) && Offset.m439equalsimpl0(getOffset(), shadow.getOffset()) && this.blurRadius == shadow.blurRadius;
    }

    public int hashCode() {
        return (((Color.m678hashCodeimpl(getColor()) * 31) + Offset.m444hashCodeimpl(getOffset())) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m679toStringimpl(getColor())) + ", offset=" + ((Object) Offset.m450toStringimpl(getOffset())) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default, reason: not valid java name */
    public static /* synthetic */ Shadow m917copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.getColor();
        }
        long j3 = j;
        ...
        return shadow.m920copyqcb84PM(j3, j4, f);
    }

    /* renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m920copyqcb84PM(long color, long offset, float blurRadius) {
