...
public abstract class Painter {
    ...
    public abstract long mo1130getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m1132drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m1133drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m1133drawx_KDEd0(DrawScope receiver, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(receiver, "$receiver");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(receiver.getLayoutDirection());
        float m511getWidthimpl = Size.m511getWidthimpl(receiver.mo1045getSizeNHjbRc()) - Size.m511getWidthimpl(j);
        float m508getHeightimpl = Size.m508getHeightimpl(receiver.mo1045getSizeNHjbRc()) - Size.m508getHeightimpl(j);
        receiver.getDrawContext().getTransform().inset(0.0f, 0.0f, m511getWidthimpl, m508getHeightimpl);
        if (f > 0.0f && Size.m511getWidthimpl(j) > 0.0f && Size.m508getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect m482Recttz77jQw = RectKt.m482Recttz77jQw(Offset.INSTANCE.m458getZeroF1C5BW0(), SizeKt.Size(Size.m511getWidthimpl(j), Size.m508getHeightimpl(j)));
                Canvas canvas = receiver.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(m482Recttz77jQw, obtainPaint());
                    onDraw(receiver);
                } finally {
                    canvas.restore();
                }
