...
public abstract class ColorSpace {
    ...
    public final int getComponentCount() {
        return ColorModel.m994getComponentCountimpl(getModel());
    }
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] fArr = new float[ColorModel.m994getComponentCountimpl(getModel())];
        fArr[0] = x;
        fArr[1] = y;
        fArr[2] = z;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m996toStringimpl(getModel())) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m993equalsimpl0(getModel(), colorSpace.getModel());
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m995hashCodeimpl(getModel())) * 31) + this.id;
    }
}
