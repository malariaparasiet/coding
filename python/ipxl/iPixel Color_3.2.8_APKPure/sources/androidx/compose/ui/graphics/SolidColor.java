...
public final class SolidColor extends Brush {
    ...
    public void mo625applyToPq9zytI(long size, Paint p, float alpha) {
        long m670copywmQWz5c$default;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (alpha != 1.0f) {
            m670copywmQWz5c$default = Color.m670copywmQWz5c$default(getValue(), Color.m673getAlphaimpl(getValue()) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            m670copywmQWz5c$default = getValue();
        }
        p.mo563setColor8_81llA(m670copywmQWz5c$default);
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m672equalsimpl0(getValue(), ((SolidColor) other).getValue());
    }

    public int hashCode() {
        return Color.m678hashCodeimpl(getValue());
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m679toStringimpl(getValue())) + ')';
    }
}
