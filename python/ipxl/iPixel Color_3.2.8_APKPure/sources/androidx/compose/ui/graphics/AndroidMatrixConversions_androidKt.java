...
public final class AndroidMatrixConversions_androidKt {
    ...
    public static final void m555setFromtUYjHk(float[] setFrom, android.graphics.Matrix matrix) {
    ...
    public static final void m554setFromEL8BTi8(android.graphics.Matrix setFrom, float[] matrix) {
        Intrinsics.checkNotNullParameter(setFrom, "$this$setFrom");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float f = matrix[2];
        if (!(f == 0.0f && matrix[6] == 0.0f && matrix[10] == 1.0f && matrix[14] == 0.0f && matrix[8] == 0.0f && matrix[9] == 0.0f && matrix[11] == 0.0f)) {
