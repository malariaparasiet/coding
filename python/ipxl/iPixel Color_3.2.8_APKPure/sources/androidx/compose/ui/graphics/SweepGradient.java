...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo646createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m463isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m521getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset(Offset.m442getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m511getWidthimpl(size) : Offset.m442getXimpl(this.center), Offset.m443getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m508getHeightimpl(size) : Offset.m443getYimpl(this.center));
        }
        return ShaderKt.m915SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m439equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int m444hashCodeimpl = ((Offset.m444hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m444hashCodeimpl + (list == null ? 0 : list.hashCode());
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m461isSpecifiedk4lQ0M(this.center) ? "center=" + ((Object) Offset.m450toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
