...
public final class ColorPainter extends Painter {
    ...
    private ColorPainter(long j) {
        this.color = j;
        this.alpha = 1.0f;
        this.intrinsicSize = Size.INSTANCE.m519getUnspecifiedNHjbRc();
    }
    ...
    protected void onDraw(DrawScope drawScope) {
        ...
        DrawScope.DefaultImpls.m1088drawRectnJ9OG0$default(drawScope, getColor(), 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m672equalsimpl0(getColor(), ((ColorPainter) other).getColor());
    }

    public int hashCode() {
        return Color.m678hashCodeimpl(getColor());
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m679toStringimpl(getColor())) + ')';
    }
