...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m2555getZeroYbymL2g();
    ...
    public final void m1134drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m2550getWidthimpl(size) > imageBitmap.getWidth() || IntSize.m2549getHeightimpl(size) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m832ImageBitmapx__hDU$default(IntSize.m2550getWidthimpl(size), IntSize.m2549getHeightimpl(size), 0, false, null, 28, null);
        ...
        long m2560toSizeozmzZPI = IntSizeKt.m2560toSizeozmzZPI(size);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.DefaultImpls.m1077drawImage9jGpkUE$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 346, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.DefaultImpls.m1088drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m697getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m595getClear0nO6VwU(), 62, null);
    }
}
