...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo646createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m519getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo625applyToPq9zytI(long size, Paint p, float alpha) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m507equalsimpl0(this.createdSize, size)) {
            shader = mo646createShaderuvyYCjk(size);
            this.internalShader = shader;
            this.createdSize = size;
        }
        if (!Color.m672equalsimpl0(p.mo557getColor0d7_KjU(), Color.INSTANCE.m697getBlack0d7_KjU())) {
            p.mo563setColor8_81llA(Color.INSTANCE.m697getBlack0d7_KjU());
        }
