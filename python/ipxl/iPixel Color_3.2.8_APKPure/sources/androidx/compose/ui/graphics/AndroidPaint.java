...
public final class AndroidPaint implements Paint {
    ...
    private int _blendMode = BlendMode.INSTANCE.m622getSrcOver0nO6VwU();
    ...
    public long mo557getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo563setColor8_81llA(long j) {
        AndroidPaint_androidKt.m569setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo562setBlendModes9anfk8(int i) {
        this._blendMode = i;
        AndroidPaint_androidKt.m568setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo561getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo567setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m573setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo559getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo565setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m571setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo560getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo566setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m572setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo558getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo564setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m570setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
