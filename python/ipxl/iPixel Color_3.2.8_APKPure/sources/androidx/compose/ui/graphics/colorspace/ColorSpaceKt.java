...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m1004connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m1017getPerceptualuksYyKA();
        }
        return m1003connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m1003connectYBCOT_4(ColorSpace connect, ColorSpace destination, int i) {
        ...
        if (ColorModel.m993equalsimpl0(connect.getModel(), ColorModel.INSTANCE.m1000getRgbxdoWZVw()) && ColorModel.m993equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m1000getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (ColorModel.m993equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m1000getRgbxdoWZVw())) {
