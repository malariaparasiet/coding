...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m1109rotateRg1IO4c$default(DrawScope rotate, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotate.mo1044getCenterF1C5BW0();
        }
        ...
        drawContext.getTransform().mo1057rotateUv8p0NA(f, j);
        block.invoke(rotate);
    ...
    public static /* synthetic */ void m1111rotateRadRg1IO4c$default(DrawScope rotateRad, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotateRad.mo1044getCenterF1C5BW0();
        }
        ...
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo1057rotateUv8p0NA(DegreesKt.degrees(f), j);
    ...
    public static /* synthetic */ void m1113scaleFgt4K4Q$default(DrawScope scale, float f, float f2, long j, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            j = scale.mo1044getCenterF1C5BW0();
        }
        ...
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo1058scale0AR0LA0(f, f2, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo1052setSizeuvyYCjk(mo1051getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m1115scaleRg1IO4c$default(DrawScope scale, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = scale.mo1044getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        ...
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo1058scale0AR0LA0(f, f, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo1052setSizeuvyYCjk(mo1051getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m1107clipRectrOu3jXo$default(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1 block, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Size.m511getWidthimpl(clipRect.mo1045getSizeNHjbRc());
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Size.m508getHeightimpl(clipRect.mo1045getSizeNHjbRc());
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
            i = ClipOp.INSTANCE.m660getIntersectrtfAjoo();
        }
        ...
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo1054clipRectN_I0leg(f5, f6, f7, f8, i);
    ...
    public static /* synthetic */ void m1105clipPathKD09W0M$default(DrawScope clipPath, Path path, int i, Function1 block, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = ClipOp.INSTANCE.m660getIntersectrtfAjoo();
        }
        ...
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo1053clipPathmtrdDE(path, i);
    ...
    public static final void m1108rotateRg1IO4c(DrawScope rotate, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotate.getDrawContext();
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
    ...
    public static final void m1110rotateRadRg1IO4c(DrawScope rotateRad, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotateRad.getDrawContext();
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
    ...
    public static final void m1112scaleFgt4K4Q(DrawScope scale, float f, float f2, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
    ...
    public static final void m1114scaleRg1IO4c(DrawScope scale, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
    ...
    public static final void m1106clipRectrOu3jXo(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipRect, "$this$clipRect");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipRect.getDrawContext();
        long mo1051getSizeNHjbRc = drawContext.mo1051getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo1054clipRectN_I0leg(f, f2, f3, f4, i);
        block.invoke(clipRect);
        drawContext.getCanvas().restore();
        drawContext.mo1052setSizeuvyYCjk(mo1051getSizeNHjbRc);
    }
    ...
    public static final void m1104clipPathKD09W0M(DrawScope clipPath, Path path, int i, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipPath, "$this$clipPath");
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipPath.getDrawContext();
