...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m1901boximpl(int i) {
    ...
    public static final boolean m1905getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl, reason: not valid java name */
    public static final boolean m1906getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1907hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1908toStringimpl(int i) {
        return "ProcessResult(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m1903equalsimpl(getValue(), obj);
    }

    public int hashCode() {
        return m1907hashCodeimpl(getValue());
    }

    public String toString() {
        return m1908toStringimpl(getValue());
    }
