...
public final class KeyEventType {
    ...
    private static final int Unknown = m1779constructorimpl(0);
    private static final int KeyUp = m1779constructorimpl(1);
    private static final int KeyDown = m1779constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyEventType m1778boximpl(int i) {
        return new KeyEventType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1779constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m1780equalsimpl(getValue(), obj);
    }

    public int hashCode() {
        return m1782hashCodeimpl(getValue());
    }
    ...
    public String toString() {
        return m1783toStringimpl(getValue());
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1783toStringimpl(int i) {
        return m1781equalsimpl0(i, KeyUp) ? "KeyUp" : m1781equalsimpl0(i, KeyDown) ? "KeyDown" : m1781equalsimpl0(i, Unknown) ? "Unknown" : "Invalid";
    }
