...
public final class KeyInputModifier implements Modifier.Element {
    ...
    public final boolean m1795processKeyInputZmokQxo(android.view.KeyEvent keyEvent) {
        ...
        if (modifiedKeyInputNode.m2046propagatePreviewKeyEventZmokQxo(keyEvent)) {
            return true;
        }
        return modifiedKeyInputNode.m2045propagateKeyEventZmokQxo(keyEvent);
    }
}
