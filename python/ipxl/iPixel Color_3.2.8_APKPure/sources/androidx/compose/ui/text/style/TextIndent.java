...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m2374copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = textIndent.getFirstLine();
        }
        if ((i & 2) != 0) {
            j2 = textIndent.getRestLine();
        }
        return textIndent.m2375copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m2375copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m2568equalsimpl0(getFirstLine(), textIndent.getFirstLine()) && TextUnit.m2568equalsimpl0(getRestLine(), textIndent.getRestLine());
    }

    public int hashCode() {
        return (TextUnit.m2572hashCodeimpl(getFirstLine()) * 31) + TextUnit.m2572hashCodeimpl(getRestLine());
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m2578toStringimpl(getFirstLine())) + ", restLine=" + ((Object) TextUnit.m2578toStringimpl(getRestLine())) + ')';
    }
}
