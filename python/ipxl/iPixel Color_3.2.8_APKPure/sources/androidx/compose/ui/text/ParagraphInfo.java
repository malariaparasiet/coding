...
public final /* data */ class ParagraphInfo {
    ...
    public final long m2121toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m442getXimpl(j), Offset.m443getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m479translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo578translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m2120toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m2189getStartimpl(j)), toGlobalIndex(TextRange.m2184getEndimpl(j)));
    }
}
