...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m2277getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m2293getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m2254getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ ImeOptions m2262copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        if ((i4 & 2) != 0) {
            i = imeOptions.getCapitalization();
        }
        if ((i4 & 4) != 0) {
            z2 = imeOptions.autoCorrect;
        }
        if ((i4 & 8) != 0) {
            i2 = imeOptions.getKeyboardType();
        }
        if ((i4 & 16) != 0) {
            i3 = imeOptions.getImeAction();
        }
        int i5 = i3;
        boolean z3 = z2;
        return imeOptions.m2263copyuxg59PA(z, i, z3, i2, i5);
    }

    /* renamed from: copy-uxg59PA, reason: not valid java name */
    public final ImeOptions m2263copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m2272equalsimpl0(getCapitalization(), imeOptions.getCapitalization()) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m2283equalsimpl0(getKeyboardType(), imeOptions.getKeyboardType()) && ImeAction.m2250equalsimpl0(getImeAction(), imeOptions.getImeAction());
    }

    public int hashCode() {
        return (((((((Boolean.hashCode(this.singleLine) * 31) + KeyboardCapitalization.m2273hashCodeimpl(getCapitalization())) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m2284hashCodeimpl(getKeyboardType())) * 31) + ImeAction.m2251hashCodeimpl(getImeAction());
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m2274toStringimpl(getCapitalization())) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m2285toStringimpl(getKeyboardType())) + ", imeAction=" + ((Object) ImeAction.m2252toStringimpl(getImeAction())) + ')';
    }
}
