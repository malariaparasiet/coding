...
public final class TextOverflow {
    ...
    private static final int Clip = m2379constructorimpl(1);
    private static final int Ellipsis = m2379constructorimpl(2);
    private static final int Visible = m2379constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextOverflow m2378boximpl(int i) {
        return new TextOverflow(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2379constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m2380equalsimpl(getValue(), obj);
    }

    public int hashCode() {
        return m2382hashCodeimpl(getValue());
    }
    ...
    public String toString() {
        return m2383toStringimpl(getValue());
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2383toStringimpl(int i) {
        return m2381equalsimpl0(i, Clip) ? "Clip" : m2381equalsimpl0(i, Ellipsis) ? "Ellipsis" : m2381equalsimpl0(i, Visible) ? "Visible" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m2385getClipgIe3tQ8() {
            return TextOverflow.Clip;
        }

        /* renamed from: getEllipsis-gIe3tQ8, reason: not valid java name */
        public final int m2386getEllipsisgIe3tQ8() {
            return TextOverflow.Ellipsis;
        }

        /* renamed from: getVisible-gIe3tQ8, reason: not valid java name */
        public final int m2387getVisiblegIe3tQ8() {
