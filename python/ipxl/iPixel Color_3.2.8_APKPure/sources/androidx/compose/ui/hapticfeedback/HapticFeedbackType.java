...
public final class HapticFeedbackType {
    ...
    public static final /* synthetic */ HapticFeedbackType m1179boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m1181equalsimpl(getValue(), obj);
    }

    public int hashCode() {
        return m1183hashCodeimpl(getValue());
    }
    ...
    public String toString() {
        return m1184toStringimpl(getValue());
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1184toStringimpl(int i) {
        Companion companion = INSTANCE;
        return m1182equalsimpl0(i, companion.m1186getLongPress5zf0vsI()) ? "LongPress" : m1182equalsimpl0(i, companion.m1187getTextHandleMove5zf0vsI()) ? "TextHandleMove" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m1186getLongPress5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m1188getLongPress5zf0vsI();
        }

        /* renamed from: getTextHandleMove-5zf0vsI, reason: not valid java name */
        public final int m1187getTextHandleMove5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m1189getTextHandleMove5zf0vsI();
        }

        public final List<HapticFeedbackType> values() {
            return CollectionsKt.listOf((Object[]) new HapticFeedbackType[]{HapticFeedbackType.m1179boximpl(m1186getLongPress5zf0vsI()), HapticFeedbackType.m1179boximpl(m1187getTextHandleMove5zf0vsI())});
        }
    }
}
