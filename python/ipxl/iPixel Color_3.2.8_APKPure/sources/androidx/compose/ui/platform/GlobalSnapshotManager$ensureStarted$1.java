...
final class GlobalSnapshotManager$ensureStarted$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:14:0x004e A[Catch: all -> 0x0056, TRY_LEAVE, TryCatch #0 {all -> 0x0056, blocks: (B:6:0x0014, B:7:0x003a, B:9:0x0042, B:10:0x002d, B:14:0x004e, B:21:0x0028), top: B:2:0x0008 }] */
    /* JADX WARN: Removed duplicated region for block: B:9:0x0042 A[Catch: all -> 0x0056, TryCatch #0 {all -> 0x0056, blocks: (B:6:0x0014, B:7:0x003a, B:9:0x0042, B:10:0x002d, B:14:0x004e, B:21:0x0028), top: B:2:0x0008 }] */
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r6) {
        ...
        L20:
            ...
            r4 = r6
            kotlinx.coroutines.channels.ReceiveChannel r4 = (kotlinx.coroutines.channels.ReceiveChannel) r4
            kotlinx.coroutines.channels.ChannelIterator r6 = r4.iterator()     // Catch: java.lang.Throwable -> L56
            r1 = r6
        L2d:
            r5.L$0 = r4     // Catch: java.lang.Throwable -> L56
            r5.L$1 = r1     // Catch: java.lang.Throwable -> L56
            r5.label = r3     // Catch: java.lang.Throwable -> L56
            java.lang.Object r6 = r1.hasNext(r5)     // Catch: java.lang.Throwable -> L56
            if (r6 != r0) goto L3a
            return r0
        L3a:
            ...
            if (r6 == 0) goto L4e
            java.lang.Object r6 = r1.next()     // Catch: java.lang.Throwable -> L56
            kotlin.Unit r6 = (kotlin.Unit) r6     // Catch: java.lang.Throwable -> L56
            androidx.compose.runtime.snapshots.Snapshot$Companion r6 = androidx.compose.runtime.snapshots.Snapshot.INSTANCE     // Catch: java.lang.Throwable -> L56
            r6.sendApplyNotifications()     // Catch: java.lang.Throwable -> L56
            goto L2d
        L4e:
