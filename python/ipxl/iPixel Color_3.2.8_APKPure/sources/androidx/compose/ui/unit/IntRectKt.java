...
public final class IntRectKt {
    ...
    public static final IntRect m2540IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m2508getXimpl(j), IntOffset.m2509getYimpl(j), IntOffset.m2508getXimpl(j) + IntSize.m2550getWidthimpl(j2), IntOffset.m2509getYimpl(j) + IntSize.m2549getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m2539IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m2508getXimpl(j), IntOffset.m2509getYimpl(j), IntOffset.m2508getXimpl(j2), IntOffset.m2509getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m2541IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m2508getXimpl(j) - i, IntOffset.m2509getYimpl(j) - i, IntOffset.m2508getXimpl(j) + i, IntOffset.m2509getYimpl(j) + i);
    }
