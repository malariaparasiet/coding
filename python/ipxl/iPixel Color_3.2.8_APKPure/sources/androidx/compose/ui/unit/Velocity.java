...
public final class Velocity {
    ...
    public static final /* synthetic */ Velocity m2606boximpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m2613equalsimpl(getPackedValue(), obj);
    }

    public int hashCode() {
        return m2617hashCodeimpl(getPackedValue());
    }
    ...
    public static final float m2607component1impl(long j) {
        return m2615getXimpl(j);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m2608component2impl(long j) {
        return m2616getYimpl(j);
    }

    /* renamed from: copy-OhffZ5M, reason: not valid java name */
    public static final long m2610copyOhffZ5M(long j, float f, float f2) {
        return VelocityKt.Velocity(f, f2);
    }

    /* renamed from: copy-OhffZ5M$default, reason: not valid java name */
    public static /* synthetic */ long m2611copyOhffZ5M$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m2615getXimpl(j);
        }
        if ((i & 2) != 0) {
        ...
        return m2610copyOhffZ5M(j, f, f2);
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2625getZero9UxMQ8M$annotations() {
        }
        ...
        public final long m2626getZero9UxMQ8M() {
            return Velocity.Zero;
        }
    }

    /* renamed from: unaryMinus-9UxMQ8M, reason: not valid java name */
    public static final long m2623unaryMinus9UxMQ8M(long j) {
        return VelocityKt.Velocity(-m2615getXimpl(j), -m2616getYimpl(j));
    }

    /* renamed from: minus-AH228Gc, reason: not valid java name */
    public static final long m2618minusAH228Gc(long j, long j2) {
        return VelocityKt.Velocity(m2615getXimpl(j) - m2615getXimpl(j2), m2616getYimpl(j) - m2616getYimpl(j2));
    }

    /* renamed from: plus-AH228Gc, reason: not valid java name */
    public static final long m2619plusAH228Gc(long j, long j2) {
        return VelocityKt.Velocity(m2615getXimpl(j) + m2615getXimpl(j2), m2616getYimpl(j) + m2616getYimpl(j2));
    }

    /* renamed from: times-adjELrA, reason: not valid java name */
    public static final long m2621timesadjELrA(long j, float f) {
        return VelocityKt.Velocity(m2615getXimpl(j) * f, m2616getYimpl(j) * f);
    }

    /* renamed from: div-adjELrA, reason: not valid java name */
    public static final long m2612divadjELrA(long j, float f) {
        return VelocityKt.Velocity(m2615getXimpl(j) / f, m2616getYimpl(j) / f);
    }

    /* renamed from: rem-adjELrA, reason: not valid java name */
    public static final long m2620remadjELrA(long j, float f) {
        return VelocityKt.Velocity(m2615getXimpl(j) % f, m2616getYimpl(j) % f);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2622toStringimpl(long j) {
        return "(" + m2615getXimpl(j) + ", " + m2616getYimpl(j) + ") px/sec";
    }

    public String toString() {
        return m2622toStringimpl(getPackedValue());
    }

    /* renamed from: getX-impl, reason: not valid java name */
    public static final float m2615getXimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getY-impl, reason: not valid java name */
    public static final float m2616getYimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
