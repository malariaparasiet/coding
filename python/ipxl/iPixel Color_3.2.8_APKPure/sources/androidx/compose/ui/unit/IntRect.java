...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m2526getSizeYbymL2g$annotations() {
    }
    ...
    public final long m2534getSizeYbymL2g() {
    ...
    public final IntRect m2538translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m2508getXimpl(offset), this.top + IntOffset.m2509getYimpl(offset), this.right + IntOffset.m2508getXimpl(offset), this.bottom + IntOffset.m2509getYimpl(offset));
    }
