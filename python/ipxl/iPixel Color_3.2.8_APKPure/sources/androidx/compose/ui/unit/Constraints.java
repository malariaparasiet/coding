...
public final class Constraints {
    ...
    private static final int[] WidthMask = {65535, 262143, MinNonFocusMask, MaxNonFocusMask};
    private static final int[] HeightMask = {MinNonFocusMask, MaxNonFocusMask, 65535, 262143};

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Constraints m2388boximpl(long j) {
    ...
    private static final int m2394getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }
    ...
    public boolean equals(Object obj) {
        return m2392equalsimpl(getValue(), obj);
    }

    public int hashCode() {
        return m2403hashCodeimpl(getValue());
    }
    ...
    public static final int m2402getMinWidthimpl(long j) {
        return ((int) (j >> MinFocusHeight)) & WidthMask[m2394getFocusIndeximpl(j)];
    }

    /* renamed from: getMaxWidth-impl, reason: not valid java name */
    public static final int m2400getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m2394getFocusIndeximpl(j)];
        if (i == 0) {
    ...
    public static final int m2401getMinHeightimpl(long j) {
        int m2394getFocusIndeximpl = m2394getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[m2394getFocusIndeximpl])) & HeightMask[m2394getFocusIndeximpl];
    }

    /* renamed from: getMaxHeight-impl, reason: not valid java name */
    public static final int m2399getMaxHeightimpl(long j) {
        int m2394getFocusIndeximpl = m2394getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[m2394getFocusIndeximpl] + 31))) & HeightMask[m2394getFocusIndeximpl];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final boolean m2396getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m2394getFocusIndeximpl(j)]) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m2395getHasBoundedHeightimpl(long j) {
        int m2394getFocusIndeximpl = m2394getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[m2394getFocusIndeximpl] + 31))) & HeightMask[m2394getFocusIndeximpl]) != 0;
    }

    /* renamed from: getHasFixedWidth-impl, reason: not valid java name */
    public static final boolean m2398getHasFixedWidthimpl(long j) {
        return m2400getMaxWidthimpl(j) == m2402getMinWidthimpl(j);
    }

    /* renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m2397getHasFixedHeightimpl(long j) {
        return m2399getMaxHeightimpl(j) == m2401getMinHeightimpl(j);
    }

    /* renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m2404isZeroimpl(long j) {
        return m2400getMaxWidthimpl(j) == 0 || m2399getMaxHeightimpl(j) == 0;
    }

    /* renamed from: copy-Zbe2FdA$default, reason: not valid java name */
    public static /* synthetic */ long m2391copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m2402getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m2400getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m2401getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m2399getMaxHeightimpl(j);
        }
        return m2390copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m2390copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        boolean z = true;
        if (!(i3 >= 0 && i >= 0)) {
        ...
        return INSTANCE.m2407createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
    }

    public String toString() {
        return m2405toStringimpl(getValue());
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2405toStringimpl(long j) {
        int m2400getMaxWidthimpl = m2400getMaxWidthimpl(j);
        String str = "Infinity";
        String valueOf = m2400getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(m2400getMaxWidthimpl);
        int m2399getMaxHeightimpl = m2399getMaxHeightimpl(j);
        if (m2399getMaxHeightimpl != Integer.MAX_VALUE) {
            str = String.valueOf(m2399getMaxHeightimpl);
        }
        return "Constraints(minWidth = " + m2402getMinWidthimpl(j) + ", maxWidth = " + valueOf + ", minHeight = " + m2401getMinHeightimpl(j) + ", maxHeight = " + str + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m2408fixedJhjzzOo(int width, int height) {
            if (!(width >= 0 && height >= 0)) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m2407createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* renamed from: fixedWidth-OenEA2s, reason: not valid java name */
        public final long m2410fixedWidthOenEA2s(int width) {
            if (!(width >= 0)) {
                throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
            }
            return m2407createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
        }

        /* renamed from: fixedHeight-OenEA2s, reason: not valid java name */
        public final long m2409fixedHeightOenEA2s(int height) {
            if (!(height >= 0)) {
                throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
            }
            return m2407createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release, reason: not valid java name */
        public final long m2407createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long j;
            ...
            if (bitsNeedForSize + bitsNeedForSize2 <= 31) {
                ...
                return Constraints.m2389constructorimpl((i3 << 33) | j | (minWidth << Constraints.MinFocusHeight) | (minHeight << i5) | (i4 << (i5 + 31)));
            }
