...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                m3567constructorimpl = Result.m3567constructorimpl(getOnFrame().invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m3567constructorimpl(ResultKt.createFailure(th)));
            } else {
                ...
                list.add((FrameAwaiter) objectRef.element);
                boolean booleanValue = Boxing.boxBoolean(isEmpty).booleanValue();
                cancellableContinuationImpl2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.compose.runtime.BroadcastFrameClock$withFrameNanos$2$1
                    ...
                    public final void invoke2(Throwable th2) {
                        ...
                        synchronized (obj) {
                            ...
                            list2.remove((BroadcastFrameClock.FrameAwaiter) objectRef2.element);
                            Unit unit = Unit.INSTANCE;
                        }
                    }
                });
