...
public final class PersistentVector<E> extends AbstractPersistentList<E> implements PersistentList<E> {
    ...
    public PersistentVector(Object[] root, Object[] tail, int i, int i2) {
        ...
        CommonFunctionsKt.m359assert(size() - UtilsKt.rootSize(size()) <= RangesKt.coerceAtMost(tail.length, 32));
    }
    ...
    private final Object[] insertIntoRoot(Object[] root, int shift, int index, Object element, ObjectRef elementCarry) {
        ...
        if (i2 < 32) {
            while (true) {
                ...
                copyOf2[i2] = insertIntoRoot((Object[]) obj2, i, 0, elementCarry.getValue(), elementCarry);
                if (i3 >= 32) {
                    break;
                }
                i2 = i3;
    ...
    private final PersistentList<E> pullLastBufferFromRoot(Object[] root, int rootSize, int shift) {
        if (shift == 0) {
            if (root.length == 33) {
                ...
                Intrinsics.checkNotNullExpressionValue(root, "java.util.Arrays.copyOf(this, newSize)");
            }
