...
public final class TrieNode<K, V> {
    ...
    private final boolean collisionContainsKey(K key) {
        ...
        if ((step2 > 0 && first <= last) || (step2 < 0 && last <= first)) {
            while (true) {
                int i = first + step2;
                if (Intrinsics.areEqual(key, this.buffer[first])) {
                    return true;
                }
                if (first == last) {
                    break;
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m359assert(this.nodeMap == 0);
        CommonFunctionsKt.m359assert(this.dataMap == 0);
        CommonFunctionsKt.m359assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m359assert(otherNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    private final TrieNode<K, V> mutablePutAllFromOtherNodeCell(TrieNode<K, V> other, int positionMask, int shift, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        if (other.hasNodeAt(positionMask)) {
            return mutablePutAll(other.nodeAtIndex$runtime_release(other.nodeIndex$runtime_release(positionMask)), shift + 5, intersectionCounter, mutator);
        }
        if (!other.hasEntryAt$runtime_release(positionMask)) {
            return this;
        }
        int entryKeyIndex$runtime_release = other.entryKeyIndex$runtime_release(positionMask);
        K keyAtIndex = other.keyAtIndex(entryKeyIndex$runtime_release);
        V valueAtKeyIndex = other.valueAtKeyIndex(entryKeyIndex$runtime_release);
        int size = mutator.size();
        TrieNode<K, V> mutablePut = mutablePut(keyAtIndex != null ? keyAtIndex.hashCode() : 0, keyAtIndex, valueAtKeyIndex, shift + 5, mutator);
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> otherNode, int shift, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        ...
        TrieNode<K, V> trieNode4 = this;
        TrieNode<K, V> otherNode2 = otherNode;
        DeltaCounter intersectionCounter2 = intersectionCounter;
        Intrinsics.checkNotNullParameter(otherNode2, "otherNode");
        Intrinsics.checkNotNullParameter(intersectionCounter2, "intersectionCounter");
        PersistentHashMapBuilder<K, V> mutator2 = mutator;
        Intrinsics.checkNotNullParameter(mutator2, "mutator");
        if (trieNode4 == otherNode2) {
            intersectionCounter2.plusAssign(trieNode4.calculateSize());
            return trieNode4;
        }
        if (shift > 30) {
            return trieNode4.mutableCollisionPutAll(otherNode2, intersectionCounter2, mutator2.getOwnership());
        }
        int i3 = trieNode4.nodeMap | otherNode2.nodeMap;
        int i4 = trieNode4.dataMap;
        int i5 = otherNode2.dataMap;
        int i6 = (i4 ^ i5) & (~i3);
        int i7 = i4 & i5;
        int i8 = i6;
        while (i7 != 0) {
            int lowestOneBit = Integer.lowestOneBit(i7);
            if (Intrinsics.areEqual(trieNode4.keyAtIndex(trieNode4.entryKeyIndex$runtime_release(lowestOneBit)), otherNode2.keyAtIndex(otherNode2.entryKeyIndex$runtime_release(lowestOneBit)))) {
                i8 |= lowestOneBit;
            } else {
                i3 |= lowestOneBit;
            }
        ...
        int i9 = 1;
        CommonFunctionsKt.m359assert((i3 & i8) == 0);
        TrieNode<K, V> trieNode5 = (Intrinsics.areEqual(trieNode4.ownedBy, mutator2.getOwnership()) && trieNode4.dataMap == i8 && trieNode4.nodeMap == i3) ? trieNode4 : new TrieNode<>(i8, i3, new Object[(Integer.bitCount(i8) * 2) + Integer.bitCount(i3)]);
        int i10 = i3;
        int i11 = 0;
        TrieNode<K, V> trieNode6 = trieNode4;
        while (i10 != 0) {
            int lowestOneBit2 = Integer.lowestOneBit(i10);
            int length = (trieNode5.getBuffer().length - i9) - i11;
            Object[] buffer = trieNode5.getBuffer();
            if (trieNode6.hasNodeAt(lowestOneBit2)) {
                makeNode = trieNode6.nodeAtIndex$runtime_release(trieNode6.nodeIndex$runtime_release(lowestOneBit2)).mutablePutAllFromOtherNodeCell(otherNode2, lowestOneBit2, shift, intersectionCounter2, mutator2);
                trieNode = otherNode2;
                i = lowestOneBit2;
                trieNode3 = trieNode6;
            } else {
                ...
                if (trieNode.hasNodeAt(lowestOneBit2)) {
                    TrieNode<K, V> trieNode7 = trieNode6;
                    makeNode = trieNode.nodeAtIndex$runtime_release(trieNode.nodeIndex$runtime_release(lowestOneBit2)).mutablePutAllFromOtherNodeCell(trieNode7, lowestOneBit2, shift, intersectionCounter, mutator);
                    i = lowestOneBit2;
                    trieNode3 = trieNode7;
                } else {
                    TrieNode trieNode8 = trieNode6;
                    int entryKeyIndex$runtime_release = trieNode8.entryKeyIndex$runtime_release(lowestOneBit2);
                    Object keyAtIndex = trieNode8.keyAtIndex(entryKeyIndex$runtime_release);
                    Object valueAtKeyIndex = trieNode8.valueAtKeyIndex(entryKeyIndex$runtime_release);
                    int entryKeyIndex$runtime_release2 = trieNode.entryKeyIndex$runtime_release(lowestOneBit2);
                    K keyAtIndex2 = trieNode.keyAtIndex(entryKeyIndex$runtime_release2);
                    trieNode2 = otherNode;
                    i = lowestOneBit2;
                    i2 = i9;
                    deltaCounter = intersectionCounter;
                    trieNode3 = this;
                    makeNode = trieNode3.makeNode(keyAtIndex != null ? keyAtIndex.hashCode() : 0, keyAtIndex, valueAtKeyIndex, keyAtIndex2 != null ? keyAtIndex2.hashCode() : 0, keyAtIndex2, trieNode.valueAtKeyIndex(entryKeyIndex$runtime_release2), shift + 5, mutator.getOwnership());
                    buffer[length] = makeNode;
                    i11++;
                    i10 ^= i;
                    mutator2 = mutator;
                    otherNode2 = trieNode2;
                    intersectionCounter2 = deltaCounter;
                    i9 = i2;
                    trieNode6 = trieNode3;
                }
            }
        ...
        TrieNode<K, V> trieNode9 = otherNode2;
        DeltaCounter deltaCounter2 = intersectionCounter2;
        int i12 = 0;
        while (i8 != 0) {
            int lowestOneBit3 = Integer.lowestOneBit(i8);
            int i13 = i12 * 2;
            if (!trieNode9.hasEntryAt$runtime_release(lowestOneBit3)) {
                int entryKeyIndex$runtime_release3 = trieNode6.entryKeyIndex$runtime_release(lowestOneBit3);
                trieNode5.getBuffer()[i13] = trieNode6.keyAtIndex(entryKeyIndex$runtime_release3);
                trieNode5.getBuffer()[i13 + 1] = trieNode6.valueAtKeyIndex(entryKeyIndex$runtime_release3);
            } else {
                int entryKeyIndex$runtime_release4 = trieNode9.entryKeyIndex$runtime_release(lowestOneBit3);
                trieNode5.getBuffer()[i13] = trieNode9.keyAtIndex(entryKeyIndex$runtime_release4);
                trieNode5.getBuffer()[i13 + 1] = trieNode9.valueAtKeyIndex(entryKeyIndex$runtime_release4);
                if (trieNode6.hasEntryAt$runtime_release(lowestOneBit3)) {
        ...
        return trieNode6.elementsIdentityEquals(trieNode5) ? trieNode6 : trieNode9.elementsIdentityEquals(trieNode5) ? trieNode9 : trieNode5;
    }
