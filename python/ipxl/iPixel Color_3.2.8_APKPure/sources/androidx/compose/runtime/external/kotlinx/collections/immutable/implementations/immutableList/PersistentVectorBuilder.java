...
public final class PersistentVectorBuilder<E> extends AbstractMutableList<E> implements PersistentList.Builder<E> {
    ...
    private final Object[] insertIntoRoot(Object[] root, int shift, int index, Object element, ObjectRef elementCarry) {
        ...
        makeMutable[indexSegment] = insertIntoRoot((Object[]) obj, i, index, element, elementCarry);
        ...
        if (i2 < 32) {
            while (true) {
                ...
                makeMutable[i2] = insertIntoRoot((Object[]) obj2, i, 0, elementCarry.getValue(), elementCarry);
                if (i3 >= 32) {
                    break;
                }
                i2 = i3;
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (size == 0) {
            CommonFunctionsKt.m359assert(index >= rootSize());
            int i2 = index & 31;
    ...
    private final void splitToBuffers(Collection<? extends E> elements, int index, Object[] startBuffer, int startBufferSize, Object[][] buffers, int nullBuffers, Object[] nextBuffer) {
        ...
        if (i3 < 32) {
            ArraysKt.copyInto(makeMutable, nextBuffer, size + 1, i2, startBufferSize);
        } else {
            int i4 = i3 - 31;
            if (nullBuffers == 1) {
            ...
            ArraysKt.copyInto(makeMutable, nextBuffer, 0, i5, startBufferSize);
            ArraysKt.copyInto(makeMutable, mutableBuffer, size + 1, i2, i5);
            nextBuffer = mutableBuffer;
        }
        Iterator<? extends E> it = elements.iterator();
        copyToBuffer(makeMutable, i2, it);
        if (1 < nullBuffers) {
            while (true) {
                int i6 = i + 1;
    ...
    private final Object removeFromTailAt(Object[] root, int rootSize, int shift, int index) {
        ...
        CommonFunctionsKt.m359assert(index < size);
        if (size == 1) {
    ...
    private final boolean removeAll(Function1<? super E, Boolean> predicate) {
        ...
        if (i == 32) {
            CommonFunctionsKt.m359assert(!leafBufferIterator.hasNext());
    ...
    private final int removeAllFromTail(Function1<? super E, Boolean> predicate, int tailSize, ObjectRef bufferRef) {
        ...
        if (removeAll == tailSize) {
            CommonFunctionsKt.m359assert(bufferRef.getValue() == this.tail);
            return tailSize;
        }
    ...
    */
    private final int removeAll(kotlin.jvm.functions.Function1<? super E, java.lang.Boolean> r8, java.lang.Object[] r9, int r10, androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableList.ObjectRef r11) {
        /*
            r7 = this;
            if (r10 <= 0) goto L2c
            r0 = 0
        ...
        L2c:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableList.PersistentVectorBuilder.removeAll(kotlin.jvm.functions.Function1, java.lang.Object[], int, androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableList.ObjectRef):int");
    }
