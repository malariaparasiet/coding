...
@DebugMetadata(c = "androidx.lifecycle.CoroutineLiveData", f = "CoroutineLiveData.kt", i = {0, 0, 1}, l = {Command.CMD_OTA_EXIT_UPDATE_MODE, Command.CMD_OTA_SEND_FIRMWARE_UPDATE_BLOCK}, m = "emitSource$lifecycle_livedata_ktx_release", n = {"this", "source", "this"}, s = {"L$0", "L$1", "L$0"})
