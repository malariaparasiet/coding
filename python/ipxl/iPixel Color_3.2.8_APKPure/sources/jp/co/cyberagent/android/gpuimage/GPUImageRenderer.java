        ...
        if (this.runOnDraw.isEmpty()) {
            runOnDraw(new Runnable() { // from class: jp.co.cyberagent.android.gpuimage.GPUImageRenderer.1
                ...
                public void run() {
                    ...
                    gPUImageRenderer.glTextureId = OpenGlUtils.loadTexture(gPUImageRenderer.glRgbBuffer, i, i2, GPUImageRenderer.this.glTextureId);
                    int i3 = GPUImageRenderer.this.imageWidth;
                    int i4 = i;
                    if (i3 != i4) {
                        GPUImageRenderer.this.imageWidth = i4;
    ...
    public void setImageBitmap(final Bitmap bitmap, final boolean z) {
        ...
        runOnDraw(new Runnable() { // from class: jp.co.cyberagent.android.gpuimage.GPUImageRenderer.5
            ...
            public void run() {
                ...
                GPUImageRenderer gPUImageRenderer = GPUImageRenderer.this;
                gPUImageRenderer.glTextureId = OpenGlUtils.loadTexture(bitmap2 != null ? bitmap2 : bitmap, gPUImageRenderer.glTextureId, z);
                if (bitmap2 != null) {
                    bitmap2.recycle();
                }
