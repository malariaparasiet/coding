...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener, View.OnLayoutChangeListener {
    ...
    private class ComponentSizeChooser extends BaseConfigChooser {
        ...
        public EGLConfig chooseConfig(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr) {
            ...
            while (i < length) {
                ...
                int findConfigAttrib = findConfigAttrib(egl102, eGLDisplay2, eGLConfig, 12325, 0);
                int findConfigAttrib2 = findConfigAttrib(egl102, eGLDisplay2, eGLConfig, 12326, 0);
                if (findConfigAttrib >= this.depthSize && findConfigAttrib2 >= this.stencilSize) {
                    int findConfigAttrib3 = findConfigAttrib(egl102, eGLDisplay2, eGLConfig, 12324, 0);
                    int findConfigAttrib4 = findConfigAttrib(egl102, eGLDisplay2, eGLConfig, 12323, 0);
                    int findConfigAttrib5 = findConfigAttrib(egl102, eGLDisplay2, eGLConfig, 12322, 0);
                    int findConfigAttrib6 = findConfigAttrib(egl102, eGLDisplay2, eGLConfig, 12321, 0);
    ...
    static class GLThread extends Thread {
        ...
        private boolean readyToDraw() {
            ...
            return this.requestRender || this.renderMode == 1;
        }
