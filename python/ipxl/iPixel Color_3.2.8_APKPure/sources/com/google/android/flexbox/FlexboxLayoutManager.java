        ...
        if (i7 != -1 || (this.mPendingScrollPosition == -1 && !z)) {
            ...
            if (isMainAxisDirectionHorizontal()) {
                if (this.mFlexLines.size() > 0) {
                    ...
                    this.mFlexboxHelper.calculateFlexLines(this.mFlexLinesResult, makeMeasureSpec, makeMeasureSpec2, i6, min, this.mAnchorInfo.mPosition, this.mFlexLines);
                    i3 = min;
                    this.mFlexLines = this.mFlexLinesResult.mFlexLines;
                    this.mFlexboxHelper.determineMainSize(makeMeasureSpec, makeMeasureSpec2, i3);
            ...
            i3 = min;
            if (this.mFlexLines.size() > 0) {
                this.mFlexboxHelper.clearFlexLines(this.mFlexLines, i3);
                min = i3;
                this.mFlexboxHelper.calculateFlexLines(this.mFlexLinesResult, makeMeasureSpec2, makeMeasureSpec, i6, min, this.mAnchorInfo.mPosition, this.mFlexLines);
