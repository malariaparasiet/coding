...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public void setText(CharSequence charSequence) {
        final String formatText = formatText(charSequence);
        ...
        ViewCompat.setAccessibilityDelegate(this.editText, new AccessibilityDelegateCompat() { // from class: com.google.android.material.timepicker.ChipTextInputComboView.1
            @Override // androidx.core.view.AccessibilityDelegateCompat
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                super.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfoCompat);
                accessibilityNodeInfoCompat.setText(formatText);
