...
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    private static abstract class ListIterator<K, V> implements Iterator<Map.Entry<K, V>>, SupportRemove<K, V> {
        ...
        @Override // com.heaton.baselib.app.event.SafeIterableMap.SupportRemove
    ...
    static class AscendingIterator<K, V> extends ListIterator<K, V> {
        ...
        @Override // com.heaton.baselib.app.event.SafeIterableMap.ListIterator
    ...
    class IteratorWithAdditions implements Iterator<Map.Entry<K, V>>, SupportRemove<K, V> {
