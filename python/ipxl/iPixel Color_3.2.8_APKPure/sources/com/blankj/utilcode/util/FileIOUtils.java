    ...
    */
    public static byte[] readFile2BytesByChannel(java.io.File r4) {
        ...
        L8:
            ...
            android.util.Log.e(r0, r2)     // Catch: java.io.IOException -> L41 java.lang.Throwable -> L55
            r0 = 0
            byte[] r0 = new byte[r0]     // Catch: java.io.IOException -> L41 java.lang.Throwable -> L55
            if (r4 == 0) goto L29
        L21:
        ...
        L29:
            return r0
        L2a:
            long r2 = r4.size()     // Catch: java.io.IOException -> L41 java.lang.Throwable -> L55
            int r0 = (int) r2     // Catch: java.io.IOException -> L41 java.lang.Throwable -> L55
            java.nio.ByteBuffer r0 = java.nio.ByteBuffer.allocate(r0)     // Catch: java.io.IOException -> L41 java.lang.Throwable -> L55
        L33:
            int r2 = r4.read(r0)     // Catch: java.io.IOException -> L41 java.lang.Throwable -> L55
            if (r2 > 0) goto L33
            byte[] r0 = r0.array()     // Catch: java.io.IOException -> L41 java.lang.Throwable -> L55
            if (r4 == 0) goto L40
            goto L21
        L40:
            return r0
    ...
    /* JADX WARN: Not initialized variable reg: 3, insn: 0x0067: MOVE (r1 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:54:0x0066 */
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    fileChannel2.map(FileChannel.MapMode.READ_ONLY, 0L, size).load().get(bArr2, 0, size);
                    if (fileChannel2 != null) {
                        try {
                            fileChannel2.close();
                            return bArr2;
