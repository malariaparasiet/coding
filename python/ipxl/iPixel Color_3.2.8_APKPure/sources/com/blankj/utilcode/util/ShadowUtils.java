...
public class ShadowUtils {
    ...
    public static class ShadowDrawable extends DrawableWrapper {
        ...
        private void drawShadow(Canvas canvas) {
            ...
            float f4 = f2 * 2.0f;
            boolean z = this.mContentBounds.width() - f4 > 0.0f;
            boolean z2 = this.mContentBounds.height() - f4 > 0.0f;
            float f5 = this.mRawShadowSize;
            float f6 = f5 - (this.mShadowTopScale * f5);
            float f7 = f5 - (this.mShadowHorizScale * f5);
            float f8 = f5 - (this.mShadowBottomScale * f5);
            float f9 = f2 == 0.0f ? 1.0f : f2 / (f7 + f2);
            float f10 = f2 == 0.0f ? 1.0f : f2 / (f6 + f2);
            float f11 = f2 == 0.0f ? 1.0f : f2 / (f8 + f2);
            ...
            if (z) {
                ...
                f = 1.0f;
                i = save3;
                canvas.drawRect(0.0f, f3, this.mContentBounds.width() - f4, -this.mCornerRadius, this.mEdgeShadowPaint);
            } else {
                f = 1.0f;
                i = save3;
            }
            ...
            if (z2) {
                ...
                canvas.drawRect(0.0f, f3, this.mContentBounds.height() - f4, -this.mCornerRadius, this.mEdgeShadowPaint);
            }
