    ...
    public static void init(String str, OnCrashListener onCrashListener) {
        if (UtilsBridge.isSpace(str)) {
            if (UtilsBridge.isSDCardEnableByEnvironment() && Utils.getApp().getExternalFilesDir(null) != null) {
                StringBuilder append = new StringBuilder().append(Utils.getApp().getExternalFilesDir(null));
                String str2 = FILE_SEP;
                str = append.append(str2).append("crash").append(str2).toString();
            } else {
                StringBuilder append2 = new StringBuilder().append(Utils.getApp().getFilesDir());
                String str3 = FILE_SEP;
                str = append2.append(str3).append("crash").append(str3).toString();
            }
        } else {
