        ...
        if (getMOnItemChildClickListener() == null) {
            ...
            while (it.hasNext()) {
                ...
                if (findViewById != null) {
                    ...
                    findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.BaseBinderAdapter$$ExternalSyntheticLambda0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
        ...
        if (getMOnItemChildLongClickListener() == null) {
            ...
            while (it2.hasNext()) {
                ...
                if (findViewById2 != null) {
                    ...
                    findViewById2.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.BaseBinderAdapter$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnLongClickListener
                        public final boolean onLongClick(View view) {
