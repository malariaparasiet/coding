...
public class NotifyAdvInfoParam extends BaseParameter {
    ...
    public byte[] getParamData() {
        ...
        bArr[i + 1] = this.isLeftCharging ? Byte.MIN_VALUE : (byte) 0;
        bArr[i + 2] = this.isRightCharging ? Byte.MIN_VALUE : (byte) 0;
        bArr[i + 3] = this.isDeviceCharging ? Byte.MIN_VALUE : (byte) 0;
