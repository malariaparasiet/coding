...
public class ParseDataUtil {
    ...
    public static BleScanMessage parseWithOTAFlagFilter(byte[] bArr, String str) {
        ...
        if (!Arrays.equals(a2, str.getBytes())) {
            JL_Log.i(a, CommonUtil.formatString("parseWithOTAFlagFilter :: flag not match. adv flag : %s, flag : %s", CHexConver.byte2HexStr(a2), CHexConver.byte2HexStr(str.getBytes())));
            return null;
        }
