...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent {
    ...
    public SmartRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mFloorDuration = MaterialCardViewHelper.DEFAULT_FADE_ANIM_DURATION;
        this.mReboundDuration = MaterialCardViewHelper.DEFAULT_FADE_ANIM_DURATION;
        this.mDragRate = 0.5f;
    ...
    */
    ...
    public RefreshLayout finishRefresh(boolean z) {
        if (z) {
            return finishRefresh(Math.min(Math.max(0, 300 - ((int) (System.currentTimeMillis() - this.mLastOpenTime))), MaterialCardViewHelper.DEFAULT_FADE_ANIM_DURATION) << 16, true, Boolean.FALSE);
        }
    ...
    public RefreshLayout finishRefreshWithNoMoreData() {
        return finishRefresh(Math.min(Math.max(0, 300 - ((int) (System.currentTimeMillis() - this.mLastOpenTime))), MaterialCardViewHelper.DEFAULT_FADE_ANIM_DURATION) << 16, true, Boolean.TRUE);
    }
    ...
    public RefreshLayout finishLoadMore(boolean z) {
        return finishLoadMore(z ? Math.min(Math.max(0, 300 - ((int) (System.currentTimeMillis() - this.mLastOpenTime))), MaterialCardViewHelper.DEFAULT_FADE_ANIM_DURATION) << 16 : 0, z, false);
    }
    ...
    public RefreshLayout finishLoadMoreWithNoMoreData() {
        return finishLoadMore(Math.min(Math.max(0, 300 - ((int) (System.currentTimeMillis() - this.mLastOpenTime))), MaterialCardViewHelper.DEFAULT_FADE_ANIM_DURATION) << 16, true, true);
    }
    ...
    public RefreshLayout closeHeaderOrFooter() {
        ...
        if (this.mKernel.animSpinner(0) == null) {
            notifyStateChanged(RefreshState.None);
            return this;
        }
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public com.scwang.smart.refresh.layout.api.RefreshKernel moveSpinner(int r27, boolean r28) {
            /*
        ...
        public RefreshKernel requestDrawBackgroundFor(RefreshComponent refreshComponent, int i) {
            ...
            if (refreshComponent.equals(SmartRefreshLayout.this.mRefreshFooter)) {
