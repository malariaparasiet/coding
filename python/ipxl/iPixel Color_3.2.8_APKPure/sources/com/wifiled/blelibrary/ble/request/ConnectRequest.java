...
public class ConnectRequest<T extends BleDevice> implements ConnectWrapperCallback<T> {
    ...
    private void doConnectException(final T t, final int i) {
        runOnUiThread(new Runnable() { // from class: com.wifiled.blelibrary.ble.request.ConnectRequest.1
    ...
    public void connect(List<T> list, final BleConnectCallback<T> bleConnectCallback) {
        this.dispatcher.excute(list, new BleConnectsDispatcher.NextCallback<T>() { // from class: com.wifiled.blelibrary.ble.request.ConnectRequest.2
    ...
    public void onConnectionChanged(final T t) {
        ...
        runOnUiThread(new Runnable() { // from class: com.wifiled.blelibrary.ble.request.ConnectRequest.3
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.lang.Runnable
            public void run() {
                if (ConnectRequest.this.connectCallback != null) {
    ...
    public void onReady(final T t) {
        ...
        runOnUiThread(new Runnable() { // from class: com.wifiled.blelibrary.ble.request.ConnectRequest.4
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.lang.Runnable
            public void run() {
                if (ConnectRequest.this.connectCallback != null) {
