...
public class Options2 {
    ...
    public Options2 setScanPeriod(long j) {
        this.scanPeriod = j;
        return this;
    }
    ...
    public Options2 setLogTAG(String str) {
        this.logTAG = str;
        return this;
    }
    ...
    public Options2 setLogBleEnable(boolean z) {
        this.logBleEnable = z;
        return this;
    }
    ...
    public Options2 setThrowBleException(boolean z) {
    ...
    public Options2 setAutoConnect(boolean z) {
        this.autoConnect = z;
        return this;
    }
    ...
    public Options2 setConnectTimeout(long j) {
    ...
    public Options2 setServiceBindFailedRetryCount(int i) {
    ...
    public Options2 setConnectFailedRetryCount(int i) {
    ...
    public Options2 setMaxConnectNum(int i) {
    ...
    public Options2 setIgnoreRepeat(boolean z) {
    ...
    public Options2 setScanFilter(ScanFilter scanFilter) {
    ...
    public Options2 setParseScanData(boolean z) {
    ...
    public Options2 setManufacturerId(int i) {
    ...
    public Options2 setBleWrapperCallback(BleWrapperCallback bleWrapperCallback) {
    ...
    public BleFactory getFactory() {
        if (this.factory == null) {
            this.factory = new BleFactory() { // from class: com.wifiled.blelibrary.ble.Options2.1
    ...
    public Options2 setFactory(BleFactory bleFactory) {
    ...
    public Options2 setUuidServicesExtra(UUID[] uuidArr) {
    ...
    public Options2 setUuidService(UUID uuid) {
    ...
    public Options2 setUuidWriteCha(UUID uuid) {
    ...
    public Options2 setUuidReadCha(UUID uuid) {
    ...
    public Options2 setUuidNotifyCha(UUID uuid) {
    ...
    public Options2 setUuidNotifyDesc(UUID uuid) {
    ...
    public Options2 setUuidOtaService(UUID uuid) {
    ...
    public Options2 setUuidOtaNotifyCha(UUID uuid) {
    ...
    public Options2 setUuidOtaWriteCha(UUID uuid) {
        this.uuid_ota_write_cha = uuid;
        return this;
    }

    public <T extends BleDevice> Ble2<T> create(Context context) {
        return create(context, null);
    }

    public <T extends BleDevice> Ble2<T> create(Context context, Ble2.InitCallback initCallback) {
        return Ble2.create(context, initCallback);
    }
}
