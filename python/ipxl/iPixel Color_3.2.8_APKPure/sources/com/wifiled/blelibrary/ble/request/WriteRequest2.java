...
@Implement(WriteRequest2.class)
/* loaded from: classes2.dex */
public class WriteRequest2<T extends BleDevice> implements WriteWrapperCallback<T> {
    ...
    private void executeEntity(EntityData entityData) {
        ...
        ThreadUtils.submit(new Callable<Boolean>() { // from class: com.wifiled.blelibrary.ble.request.WriteRequest2.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // java.util.concurrent.Callable
            public Boolean call() throws Exception {
                WriteRequest2.this.isWritingEntity = true;
                WriteRequest2.this.isAutoWriteMode = isAutoWriteMode;
                int length = data.length;
                int i = length;
                int i2 = 0;
                while (i2 < length) {
                    if (!WriteRequest2.this.isWritingEntity) {
                        if (WriteRequest2.this.bleWriteEntityCallback != null) {
                            WriteRequest2.this.bleWriteEntityCallback.onWriteCancel();
                            WriteRequest2.this.isAutoWriteMode = false;
                        }
                        return false;
                    }
                    int i3 = packLength;
                    ...
                    if (!bleRequest.writeCharacteristic(address, bArr)) {
                        if (WriteRequest2.this.bleWriteEntityCallback != null) {
                            WriteRequest2.this.bleWriteEntityCallback.onWriteFailed();
                            WriteRequest2.this.isWritingEntity = false;
                            WriteRequest2.this.isAutoWriteMode = false;
                            return false;
                        }
                    } else if (WriteRequest2.this.bleWriteEntityCallback != null) {
                        WriteRequest2.this.bleWriteEntityCallback.onWriteProgress(new BigDecimal(i2 / length).setScale(2, 4).doubleValue());
                    }
                    if (isAutoWriteMode) {
                        synchronized (WriteRequest2.this.lock) {
                            WriteRequest2.this.lock.wait(500L);
                        }
                    } else {
                        try {
                            Thread.sleep(delay);
                ...
                if (WriteRequest2.this.bleWriteEntityCallback != null) {
                    WriteRequest2.this.bleWriteEntityCallback.onWriteSuccess();
                    WriteRequest2.this.isWritingEntity = false;
                    WriteRequest2.this.isAutoWriteMode = false;
                }
                return true;
