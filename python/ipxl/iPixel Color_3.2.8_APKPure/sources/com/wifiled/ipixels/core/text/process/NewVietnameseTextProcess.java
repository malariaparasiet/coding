...
/* compiled from: NewVietnameseTextProcess.kt */
@Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u001e\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r2\f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000fH\u0016J&\u0010\u0011\u001a\u00020\u00122\u0006\u0010\f\u001a\u00020\r2\f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f2\u0006\u0010\u0013\u001a\u00020\u0014H\u0002R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0015"}, d2 = {"Lcom/wifiled/ipixels/core/text/process/NewVietnameseTextProcess;", "Lcom/wifiled/ipixels/core/text/process/ITextProcess;", "<init>", "()V", "sendData", "", "isMoreThan", "", "sendTextCount", "", "textToByteData", "Lcom/wifiled/ipixels/core/text/process/TextData;", "textStr", "", "mTexts", "", "Lcom/wifiled/ipixels/ui/text/vo/TextEmojiVO;", "normalMove", "", "eventText", "Lcom/wifiled/ipixels/event/EventText;", "app_googleRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class NewVietnameseTextProcess extends ITextProcess {
    ...
    private final void normalMove(String textStr, List<TextEmojiVO> mTexts, EventText eventText) {
        Bitmap charBitmapVG;
        Log.v("ruis", "NewVietnameseTextProcess textStr-----" + textStr);
        boolean containsVietnamese = CharacterUtilsKt.containsVietnamese(textStr);
        boolean containsGreekChars = CharacterUtilsKt.containsGreekChars(textStr);
        int size = mTexts.size();
        for (int i = 0; i < size; i++) {
            String replace$default = StringsKt.replace$default(mTexts.get(i).getText(), "\n", " ", false, 4, (Object) null);
            if (replace$default.length() != 0 && (charBitmapVG = TextAgreement.getCharBitmapVG(replace$default, mTexts.get(i).getTextHeight(), mTexts.get(i).getTextColor(), containsVietnamese, containsGreekChars)) != null) {
                int textColor = mTexts.get(i).getTextColor();
                byte[] bArr = {ByteCompanionObject.MIN_VALUE, (byte) Color.red(textColor), (byte) Color.green(textColor), (byte) Color.blue(textColor), (byte) charBitmapVG.getWidth(), (byte) charBitmapVG.getHeight()};
                byte[] textData = TextAgreement.getTextData(charBitmapVG);
