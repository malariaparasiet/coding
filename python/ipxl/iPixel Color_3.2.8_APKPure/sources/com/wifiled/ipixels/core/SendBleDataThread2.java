...
public class SendBleDataThread2 extends Thread {
    ...
    private BleManager2 mBleManager;
    ...
    public SendBleDataThread2(BleManager2 manager, OnThreadStateListener listener) {
        super(TAG);
                ...
                while (this.isDataSend) {
                    ...
                    if (this.mQueue.isEmpty()) {
                        ...
                        if (bleSendTask != null) {
                            ...
                            if (this.isWaitingForCallback) {
                                try {
                                    this.mQueue.wait(BleManager2.get().getSEND_DATA_MAX_TIMEOUT());
