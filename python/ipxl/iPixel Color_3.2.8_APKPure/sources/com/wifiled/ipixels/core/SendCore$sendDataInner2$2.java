...
@Metadata(d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016J\u0010\u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0007H\u0016¨\u0006\b"}, d2 = {"com/wifiled/ipixels/core/SendCore$sendDataInner2$2", "Lcom/wifiled/ipixels/core/send/SendResultCallback;", "onResult", "", "result", "", "onError", "", "app_googleRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class SendCore$sendDataInner2$2 implements SendResultCallback {
    ...
    final /* synthetic */ Ref.ObjectRef<Disposable> $disposable2;
    ...
    SendCore$sendDataInner2$2(Ref.ObjectRef<Disposable> objectRef, Ref.IntRef intRef, Ref.ObjectRef<SendCore.CallbackBuilder> objectRef2, byte[] bArr, Ref.IntRef intRef2, List<byte[]> list, Ref.IntRef intRef3, Ref.ObjectRef<byte[]> objectRef3, int i, byte[] bArr2, byte b, boolean z) {
        this.$disposable2 = objectRef;
    ...
    public void onResult(byte[] result) {
        ...
        if (result.length == 5) {
            LogUtils.vTag("ruis", "sendCompat2 ------" + ByteUtils.toHexString(result));
        }
        ...
        while (true) {
            if (!it.hasNext()) {
                ...
                Disposable disposable2 = this.$disposable2.element;
                if (disposable2 != null) {
                    disposable2.dispose();
                }
                this.$disposable2.element = null;
                z = true;
            }
        }
        if (!z) {
        ...
        if (z && this.$perBlockData.size() > 0) {
            ...
            Disposable disposable3 = this.$disposable2.element;
            if (disposable3 != null && !disposable3.isDisposed() && (disposable = this.$disposable2.element) != null) {
                disposable.dispose();
            }
            Ref.ObjectRef<Disposable> objectRef = this.$disposable2;
            ...
            final Function1 function1 = new Function1() { // from class: com.wifiled.ipixels.core.SendCore$sendDataInner2$2$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    Unit onResult$lambda$0;
                    onResult$lambda$0 = SendCore$sendDataInner2$2.onResult$lambda$0(Ref.ObjectRef.this, (Long) obj);
                    return onResult$lambda$0;
                }
            };
            objectRef.element = observeOn.subscribe(new Consumer() { // from class: com.wifiled.ipixels.core.SendCore$sendDataInner2$2$$ExternalSyntheticLambda1
                @Override // io.reactivex.functions.Consumer
                public final void accept(Object obj) {
                    Function1.this.invoke(obj);
                }
            });
            SendCore.INSTANCE.sendCompat2(this.$payload.element, this);
        }
        i = SendCore.tProcess;
        if (i != length && !z) {
