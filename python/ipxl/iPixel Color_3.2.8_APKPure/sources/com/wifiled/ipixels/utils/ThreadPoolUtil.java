...
public class ThreadPoolUtil {
    ...
    private static ThreadFactory threadFactory = new ThreadFactory() { // from class: com.wifiled.ipixels.utils.ThreadPoolUtil.1
    ...
    Callable<Runnable> call = new Callable() { // from class: com.wifiled.ipixels.utils.ThreadPoolUtil$$ExternalSyntheticLambda0
    ...
    public static void scheduleAtFixedRate(Runnable runnable, int iSecond) {
        getScheExeSer();
        scheduleExcutor.scheduleAtFixedRate(runnable, 1L, iSecond, TimeUnit.SECONDS);
    }

    public static void scheduleWithFixedDelay(Runnable runnable, int iSecond) {
        getScheExeSer();
    ...
    static /* synthetic */ Runnable lambda$new$1() throws Exception {
        return new Runnable() { // from class: com.wifiled.ipixels.utils.ThreadPoolUtil$$ExternalSyntheticLambda1
