...
public final class ItemAnim32962Binding implements ViewBinding {
    ...
    private ItemAnim32962Binding(ConstraintLayout rootView, ImageView ivAnimPreview, RelativeLayout rl128bg, RelativeLayout rlImageOutsideFrame, TextView tvIndex) {
    ...
    public static ItemAnim32962Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemAnim32962Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_anim_3296_2, parent, false);
        if (attachToParent) {
    ...
    public static ItemAnim32962Binding bind(View rootView) {
        ...
        if (imageView != null) {
            ...
            if (relativeLayout != null) {
                ...
                if (relativeLayout2 != null) {
                    ...
                    if (textView != null) {
                        return new ItemAnim32962Binding((ConstraintLayout) rootView, imageView, relativeLayout, relativeLayout2, textView);
                    }
                }
            }
        }
