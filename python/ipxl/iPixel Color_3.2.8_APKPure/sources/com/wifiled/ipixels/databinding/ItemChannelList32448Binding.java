...
public final class ItemChannelList32448Binding implements ViewBinding {
    ...
    private ItemChannelList32448Binding(ConstraintLayout rootView, ImageView ivChannelFix, ImageView ivChannelImagGifItem, ImageView ivChlDel, ImageView ivChlSel, ObjectarxItem objectarxItem, RelativeLayout relayoutChannelText, LedView rlChannelTextBg, TextView tvNum) {
    ...
    public static ItemChannelList32448Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemChannelList32448Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_channel_list_32448, parent, false);
        if (attachToParent) {
    ...
    public static ItemChannelList32448Binding bind(View rootView) {
                        ...
                        if (objectarxItem != null) {
                            ...
                            if (relativeLayout != null) {
                                ...
                                if (ledView != null) {
                                    ...
                                    if (textView != null) {
                                        return new ItemChannelList32448Binding((ConstraintLayout) rootView, imageView, imageView2, imageView3, imageView4, objectarxItem, relativeLayout, ledView, textView);
                                    }
                                }
                            }
                        }
