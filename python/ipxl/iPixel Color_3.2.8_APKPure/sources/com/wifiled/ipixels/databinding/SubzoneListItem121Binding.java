...
public final class SubzoneListItem121Binding implements ViewBinding {
    ...
    public static SubzoneListItem121Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static SubzoneListItem121Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.subzone_list_item_12_1, parent, false);
        if (attachToParent) {
    ...
    public static SubzoneListItem121Binding bind(View rootView) {
        int i = R.id.image;
                                    ...
                                    if (templateViewFour12 != null) {
                                        ...
                                        if (templateViewFive12 != null) {
                                            ...
                                            if (templateViewSix12 != null) {
                                                return new SubzoneListItem121Binding(constraintLayout, imageView, constraintLayout, imageView2, imageView3, templateViewOne12, templateViewTwo12, templateViewThree12, constraintLayout2, templateViewFour12, templateViewFive12, templateViewSix12);
                                            }
                                        }
                                    }
                                }
