...
public final class ItemRc81BusinessBinding implements ViewBinding {
    ...
    private ItemRc81BusinessBinding(ConstraintLayout rootView, ImageView ivAnimEdit, ImageView ivAnimPreview, ImageView ivAnimSelect, ImageView ivNum, ObjectarxItem objectarxItem, RelativeLayout relayoutChannelText, RelativeLayout rlImageOutsideFrame) {
    ...
    public static ItemRc81BusinessBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemRc81BusinessBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_rc_8_1_business, parent, false);
        if (attachToParent) {
    ...
    public static ItemRc81BusinessBinding bind(View rootView) {
                        ...
                        if (objectarxItem != null) {
                            ...
                            if (relativeLayout != null) {
                                ...
                                if (relativeLayout2 != null) {
                                    return new ItemRc81BusinessBinding((ConstraintLayout) rootView, imageView, imageView2, imageView3, imageView4, objectarxItem, relativeLayout, relativeLayout2);
                                }
                            }
                        }
                    }
