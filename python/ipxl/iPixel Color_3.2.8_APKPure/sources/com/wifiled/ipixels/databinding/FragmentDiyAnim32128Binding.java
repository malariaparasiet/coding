...
public final class FragmentDiyAnim32128Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim32128Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim32128Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_32128, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim32128Binding bind(View rootView) {
