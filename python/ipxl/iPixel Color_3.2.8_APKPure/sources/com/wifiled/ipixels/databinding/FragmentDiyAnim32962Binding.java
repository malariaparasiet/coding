...
public final class FragmentDiyAnim32962Binding implements ViewBinding {
    ...
    public final AppCompatSeekBar sbAnimAlpha;
    public final AppCompatSeekBar sbAnimSpeed;
    public final TextView tvEdit;

    private FragmentDiyAnim32962Binding(ConstraintLayout rootView, ImageView btnSelect, ConstraintLayout clEditBg, FrameLayout flPreview, Guideline glBottom, Guideline glEdit, Guideline guideline4, Guideline guideline5, ConstraintLayout ilDiyAnimToolbar, ImageView ivDiyAnimClear, CustomImageView ivDiyAnimCopy, CustomImageView ivDiyAnimDelete, CustomImageView ivDiyAnimEdit, CustomImageView ivDiyAnimEditOk, ImageView ivDiyAnimPlay, ImageView ivGitPreview, RelativeLayout rl128bg, RecyclerView rlDiyAnimAddItem, RelativeLayout rlDiyLightSeek, RelativeLayout rlDiySpeedSeek, AppCompatSeekBar sbAnimAlpha, AppCompatSeekBar sbAnimSpeed, TextView tvEdit) {
    ...
    public static FragmentDiyAnim32962Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim32962Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_3296_2, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim32962Binding bind(View rootView) {
                                                                ...
                                                                if (imageView4 != null) {
                                                                    ...
                                                                    if (relativeLayout != null) {
                                                                        ...
                                                                        if (recyclerView != null) {
                                                                            ...
                                                                            RelativeLayout relativeLayout2 = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.rl_diy_light_seek);
                                                                            if (relativeLayout2 != null) {
                                                                                i = R.id.rl_diy_speed_seek;
                                                                                RelativeLayout relativeLayout3 = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.rl_diy_speed_seek);
                                                                                if (relativeLayout3 != null) {
                                                                                    i = R.id.sb_anim_alpha;
                                                                                    AppCompatSeekBar appCompatSeekBar = (AppCompatSeekBar) ViewBindings.findChildViewById(rootView, R.id.sb_anim_alpha);
                                                                                    if (appCompatSeekBar != null) {
                                                                                        i = R.id.sb_anim_speed;
                                                                                        AppCompatSeekBar appCompatSeekBar2 = (AppCompatSeekBar) ViewBindings.findChildViewById(rootView, R.id.sb_anim_speed);
                                                                                        if (appCompatSeekBar2 != null) {
                                                                                            i = R.id.tv_edit;
                                                                                            TextView textView = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_edit);
                                                                                            if (textView != null) {
                                                                                                return new FragmentDiyAnim32962Binding((ConstraintLayout) rootView, imageView, constraintLayout, frameLayout, guideline, guideline2, guideline3, guideline4, constraintLayout2, imageView2, customImageView, customImageView2, customImageView3, customImageView4, imageView3, imageView4, relativeLayout, recyclerView, relativeLayout2, relativeLayout3, appCompatSeekBar, appCompatSeekBar2, textView);
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
