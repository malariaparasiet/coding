...
public final class ViewTemplateFour114Binding implements ViewBinding {
    ...
    public static ViewTemplateFour114Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewTemplateFour114Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.view_template_four_1_14, parent, false);
        if (attachToParent) {
    ...
    public static ViewTemplateFour114Binding bind(View rootView) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (objectarxItem2 != null) {
                                                ...
                                                if (constraintLayout != null) {
                                                    return new ViewTemplateFour114Binding((ConstraintLayout) rootView, findChildViewById, findChildViewById2, findChildViewById3, imageView, textView, relativeLayout, objectarxItem, textView2, relativeLayout2, objectarxItem2, constraintLayout);
                                                }
                                            }
                                        }
                                    }
