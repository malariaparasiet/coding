...
public final class ItemChannelListBinding implements ViewBinding {
    ...
    private ItemChannelListBinding(ConstraintLayout rootView, ImageView ivChannelFix, ImageView ivChannelImagGifItem, ImageView ivChlDel, ImageView ivChlSel, ObjectarxItem objectarxItem, RelativeLayout relayoutChannelText, LedView rlChannelTextBg, TextView tvNum) {
    ...
    public static ItemChannelListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemChannelListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_channel_list, parent, false);
        if (attachToParent) {
    ...
    public static ItemChannelListBinding bind(View rootView) {
                        ...
                        if (objectarxItem != null) {
                            ...
                            if (relativeLayout != null) {
                                ...
                                if (ledView != null) {
                                    ...
                                    if (textView != null) {
                                        return new ItemChannelListBinding((ConstraintLayout) rootView, imageView, imageView2, imageView3, imageView4, objectarxItem, relativeLayout, ledView, textView);
                                    }
                                }
                            }
                        }
