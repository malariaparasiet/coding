...
public final class FragmentDiyAnim16192Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim16192Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim16192Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_16192, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim16192Binding bind(View rootView) {
                                                                            ...
                                                                            if (relativeLayout2 != null) {
                                                                                ...
                                                                                if (appCompatSeekBar != null) {
                                                                                    ...
                                                                                    if (appCompatSeekBar2 != null) {
                                                                                        ...
                                                                                        if (textView != null) {
                                                                                            return new FragmentDiyAnim16192Binding((ConstraintLayout) rootView, imageView, constraintLayout, frameLayout, guideline, guideline2, guideline3, guideline4, constraintLayout2, imageView2, customImageView, customImageView2, customImageView3, customImageView4, imageView3, imageView4, recyclerView, relativeLayout, relativeLayout2, appCompatSeekBar, appCompatSeekBar2, textView);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
