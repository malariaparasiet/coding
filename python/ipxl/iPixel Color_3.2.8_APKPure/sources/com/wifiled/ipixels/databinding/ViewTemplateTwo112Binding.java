...
public final class ViewTemplateTwo112Binding implements ViewBinding {
    ...
    private ViewTemplateTwo112Binding(ConstraintLayout rootView, ObjectarxItem objectarxItem1, View tem2BorderView1, ImageView tem2Iv1, TextView tem2Tv1, RelativeLayout tem2Tv1Text, ConstraintLayout template) {
    ...
    public static ViewTemplateTwo112Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewTemplateTwo112Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.view_template_two_1_12, parent, false);
        if (attachToParent) {
    ...
    public static ViewTemplateTwo112Binding bind(View rootView) {
                    ...
                    if (textView != null) {
                        ...
                        if (relativeLayout != null) {
                            ...
                            if (constraintLayout != null) {
                                return new ViewTemplateTwo112Binding((ConstraintLayout) rootView, objectarxItem, findChildViewById, imageView, textView, relativeLayout, constraintLayout);
                            }
                        }
                    }
                }
