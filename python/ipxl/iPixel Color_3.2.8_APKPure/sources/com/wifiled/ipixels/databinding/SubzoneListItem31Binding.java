...
public final class SubzoneListItem31Binding implements ViewBinding {
    ...
    public static SubzoneListItem31Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static SubzoneListItem31Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.subzone_list_item_3_1, parent, false);
        if (attachToParent) {
    ...
    public static SubzoneListItem31Binding bind(View rootView) {
        int i = R.id.image;
                                    ...
                                    if (templateViewFour12 != null) {
                                        ...
                                        if (templateViewFive12 != null) {
                                            ...
                                            if (templateViewSix12 != null) {
                                                return new SubzoneListItem31Binding(constraintLayout, imageView, constraintLayout, imageView2, imageView3, templateViewOne12, templateViewTwo12, templateViewThree12, constraintLayout2, templateViewFour12, templateViewFive12, templateViewSix12);
                                            }
                                        }
                                    }
                                }
