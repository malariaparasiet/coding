...
public final class FragmentDiyAnim16144Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim16144Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim16144Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_16144, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim16144Binding bind(View rootView) {
