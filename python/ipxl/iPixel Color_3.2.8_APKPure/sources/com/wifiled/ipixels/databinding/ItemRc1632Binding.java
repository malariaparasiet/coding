...
public final class ItemRc1632Binding implements ViewBinding {
    ...
    private ItemRc1632Binding(ConstraintLayout rootView, ImageView ivAnimPreview, ImageView ivAnimSelect, RelativeLayout rlImageOutsideFrame, TextView tvIndex) {
    ...
    public static ItemRc1632Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemRc1632Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_rc_1632, parent, false);
        if (attachToParent) {
    ...
    public static ItemRc1632Binding bind(View rootView) {
        ...
        if (imageView != null) {
            ...
            if (imageView2 != null) {
                ...
                if (relativeLayout != null) {
                    ...
                    if (textView != null) {
                        return new ItemRc1632Binding((ConstraintLayout) rootView, imageView, imageView2, relativeLayout, textView);
                    }
                }
            }
        }
