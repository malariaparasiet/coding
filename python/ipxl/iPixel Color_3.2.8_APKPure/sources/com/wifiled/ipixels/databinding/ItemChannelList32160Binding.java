...
public final class ItemChannelList32160Binding implements ViewBinding {
    ...
    private ItemChannelList32160Binding(ConstraintLayout rootView, ImageView ivChannelFix, ImageView ivChannelImagGifItem, ImageView ivChlDel, ImageView ivChlSel, ImageView leftEyesGif, ObjectarxItem objectarxItem, RelativeLayout relayoutChannelText, ImageView rightEyesGif, LedView rlChannelTextBg, TextView tvNum) {
    ...
    public static ItemChannelList32160Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemChannelList32160Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_channel_list_32160, parent, false);
        if (attachToParent) {
    ...
    public static ItemChannelList32160Binding bind(View rootView) {
                                ...
                                if (relativeLayout != null) {
                                    ...
                                    if (imageView6 != null) {
                                        ...
                                        if (ledView != null) {
                                            ...
                                            if (textView != null) {
                                                return new ItemChannelList32160Binding((ConstraintLayout) rootView, imageView, imageView2, imageView3, imageView4, imageView5, objectarxItem, relativeLayout, imageView6, ledView, textView);
                                            }
                                        }
                                    }
                                }
