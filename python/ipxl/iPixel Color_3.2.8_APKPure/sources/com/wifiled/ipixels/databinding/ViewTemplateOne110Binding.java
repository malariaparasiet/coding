...
public final class ViewTemplateOne110Binding implements ViewBinding {
    ...
    public static ViewTemplateOne110Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewTemplateOne110Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.view_template_one_1_10, parent, false);
        if (attachToParent) {
    ...
    public static ViewTemplateOne110Binding bind(View rootView) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (constraintLayout != null) {
                                                ...
                                                if (constraintLayout2 != null) {
                                                    return new ViewTemplateOne110Binding((ConstraintLayout) rootView, imageView, objectarxItem, objectarxItem2, findChildViewById, findChildViewById2, textView, relativeLayout, textView2, relativeLayout2, constraintLayout, constraintLayout2);
                                                }
                                            }
                                        }
                                    }
