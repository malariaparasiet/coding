...
public final class FragmentDiyAnim1236Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim1236Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim1236Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_1236, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim1236Binding bind(View rootView) {
        ...
        if (imageView != null) {
            ...
            if (constraintLayout != null) {
                ...
                if (frameLayout != null) {
                    i = R.id.gl_edit;
                    Guideline guideline = (Guideline) ViewBindings.findChildViewById(rootView, R.id.gl_edit);
                    if (guideline != null) {
                        i = R.id.guideline4;
                        Guideline guideline2 = (Guideline) ViewBindings.findChildViewById(rootView, R.id.guideline4);
                        if (guideline2 != null) {
                            i = R.id.guideline5;
                            Guideline guideline3 = (Guideline) ViewBindings.findChildViewById(rootView, R.id.guideline5);
                            if (guideline3 != null) {
                                                                        ...
                                                                        if (relativeLayout2 != null) {
                                                                            ...
                                                                            if (verticalSeekBar != null) {
                                                                                ...
                                                                                if (verticalSeekBar2 != null) {
                                                                                    ...
                                                                                    if (textView != null) {
                                                                                        return new FragmentDiyAnim1236Binding((ConstraintLayout) rootView, imageView, constraintLayout, frameLayout, guideline, guideline2, guideline3, constraintLayout2, imageView2, customImageView, customImageView2, customImageView3, customImageView4, imageView3, imageView4, recyclerView, relativeLayout, relativeLayout2, verticalSeekBar, verticalSeekBar2, textView);
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
