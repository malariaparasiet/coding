...
public final class ItemRc101BusinessBinding implements ViewBinding {
    ...
    private ItemRc101BusinessBinding(ConstraintLayout rootView, ImageView ivAnimEdit, ImageView ivAnimPreview, ImageView ivAnimSelect, ImageView ivNum, ObjectarxItem objectarxItem, RelativeLayout relayoutChannelText, RelativeLayout rlImageOutsideFrame) {
    ...
    public static ItemRc101BusinessBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemRc101BusinessBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_rc_10_1_business, parent, false);
        if (attachToParent) {
    ...
    public static ItemRc101BusinessBinding bind(View rootView) {
                        ...
                        if (objectarxItem != null) {
                            ...
                            if (relativeLayout != null) {
                                ...
                                if (relativeLayout2 != null) {
                                    return new ItemRc101BusinessBinding((ConstraintLayout) rootView, imageView, imageView2, imageView3, imageView4, objectarxItem, relativeLayout, relativeLayout2);
                                }
                            }
                        }
                    }
