...
public final class ItemImage32962Binding implements ViewBinding {
    ...
    private ItemImage32962Binding(ConstraintLayout rootView, ImageView ivPreview, RelativeLayout rl128bg, RelativeLayout rlImageOutsideFrame, RelativeLayout rlSelect) {
    ...
    public static ItemImage32962Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemImage32962Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_image_3296_2, parent, false);
        if (attachToParent) {
    ...
    public static ItemImage32962Binding bind(View rootView) {
            ...
            if (relativeLayout != null) {
                ...
                if (relativeLayout2 != null) {
                    ...
                    if (relativeLayout3 != null) {
                        return new ItemImage32962Binding((ConstraintLayout) rootView, imageView, relativeLayout, relativeLayout2, relativeLayout3);
                    }
                }
            }
        }
