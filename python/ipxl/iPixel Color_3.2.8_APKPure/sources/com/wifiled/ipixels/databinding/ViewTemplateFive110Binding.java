...
public final class ViewTemplateFive110Binding implements ViewBinding {
    ...
    public static ViewTemplateFive110Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewTemplateFive110Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.view_template_five_1_10, parent, false);
        if (attachToParent) {
    ...
    public static ViewTemplateFive110Binding bind(View rootView) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (objectarxItem2 != null) {
                                                ...
                                                if (constraintLayout != null) {
                                                    return new ViewTemplateFive110Binding((ConstraintLayout) rootView, findChildViewById, findChildViewById2, findChildViewById3, imageView, textView, relativeLayout, objectarxItem, textView2, relativeLayout2, objectarxItem2, constraintLayout);
                                                }
                                            }
                                        }
                                    }
