...
public final class FragmentDiyAnim32160Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim32160Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim32160Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_32160, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim32160Binding bind(View rootView) {
