...
public final class ActivitySubzoneListBinding implements ViewBinding {
    ...
    private ActivitySubzoneListBinding(ConstraintLayout rootView, ConstraintLayout clBtn, ConstraintLayout ilTextToolbar, CustomImageView ivBack, AppCompatImageView ivDelete, AppCompatImageView ivEdit, CustomImageView ivMiddle, CustomImageView ivRight, CustomImageView ivRightSubtitle, ConstraintLayout main, RecyclerView rvList, TextView tvRight, TextView tvTitle) {
    ...
    public static ActivitySubzoneListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivitySubzoneListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.activity_subzone_list, parent, false);
        if (attachToParent) {
    ...
    public static ActivitySubzoneListBinding bind(View rootView) {
        int i = R.id.cl_btn;
                                    ...
                                    if (customImageView4 != null) {
                                        ...
                                        if (recyclerView != null) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (textView2 != null) {
                                                    return new ActivitySubzoneListBinding(constraintLayout3, constraintLayout, constraintLayout2, customImageView, appCompatImageView, appCompatImageView2, customImageView2, customImageView3, customImageView4, constraintLayout3, recyclerView, textView, textView2);
                                                }
                                            }
                                        }
                                    }
