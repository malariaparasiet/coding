...
public final class ViewTemplateOne14Binding implements ViewBinding {
    ...
    public static ViewTemplateOne14Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewTemplateOne14Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.view_template_one_1_4, parent, false);
        if (attachToParent) {
    ...
    public static ViewTemplateOne14Binding bind(View rootView) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (constraintLayout != null) {
                                                ...
                                                if (constraintLayout2 != null) {
                                                    return new ViewTemplateOne14Binding((ConstraintLayout) rootView, imageView, objectarxItem, objectarxItem2, findChildViewById, findChildViewById2, textView, relativeLayout, textView2, relativeLayout2, constraintLayout, constraintLayout2);
                                                }
                                            }
                                        }
                                    }
