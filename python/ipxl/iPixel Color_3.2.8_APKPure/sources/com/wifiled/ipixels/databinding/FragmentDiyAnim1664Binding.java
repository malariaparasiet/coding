...
public final class FragmentDiyAnim1664Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim1664Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim1664Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_1664, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim1664Binding bind(View rootView) {
