...
public final class FragmentDiyAnim1696Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim1696Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim1696Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_1696, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim1696Binding bind(View rootView) {
