...
public final class ActivityMusicWideBinding implements ViewBinding {
    ...
    public final ImageView ivRhythmAnim;
    public final ConstraintLayout llSeekbar;
    public final RhythmLedView2 rhyledview1;
    public final RhythmLedView2 rhyledview2;
    public final RhythmLedView2 rhyledview3;
    ...
    private ActivityMusicWideBinding(RelativeLayout rootView, ConstraintLayout constraintLayout3, ConstraintLayout ilMusicToolbar, ImageView ivMode, ImageView ivNext, ImageView ivPlay, ImageView ivPre, ImageView ivRhyOutsideImageBg, ImageView ivRhythm, ImageView ivRhythmAnim, ConstraintLayout llSeekbar, RhythmLedView2 rhyledview1, RhythmLedView2 rhyledview2, RhythmLedView2 rhyledview3, ConstraintLayout rlPlay, LinearLayout rlRhyBg, RelativeLayout rlRoot, ConstraintLayout rlTitle, SeekBar sb, TextView tvSbDuration, TextView tvSbTime, TextView tvSongArtist, TextView tvSongName, ViewPagerAllResponse vpRhyhm) {
    ...
    public static ActivityMusicWideBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityMusicWideBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.activity_music_wide, parent, false);
        if (attachToParent) {
    ...
    public static ActivityMusicWideBinding bind(View rootView) {
                        ...
                        if (imageView3 != null) {
                            ...
                            if (imageView4 != null) {
                                ...
                                if (imageView5 != null) {
                                    ...
                                    if (imageView6 != null) {
                                        i = R.id.iv_rhythm_anim;
                                        ImageView imageView7 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.iv_rhythm_anim);
                                        if (imageView7 != null) {
                                            i = R.id.ll_seekbar;
                                            ConstraintLayout constraintLayout3 = (ConstraintLayout) ViewBindings.findChildViewById(rootView, R.id.ll_seekbar);
                                            if (constraintLayout3 != null) {
                                                i = R.id.rhyledview_1;
                                                RhythmLedView2 rhythmLedView2 = (RhythmLedView2) ViewBindings.findChildViewById(rootView, R.id.rhyledview_1);
                                                if (rhythmLedView2 != null) {
                                                    i = R.id.rhyledview_2;
                                                    RhythmLedView2 rhythmLedView22 = (RhythmLedView2) ViewBindings.findChildViewById(rootView, R.id.rhyledview_2);
                                                    if (rhythmLedView22 != null) {
                                                        i = R.id.rhyledview_3;
                                                        RhythmLedView2 rhythmLedView23 = (RhythmLedView2) ViewBindings.findChildViewById(rootView, R.id.rhyledview_3);
                                                                                        ...
                                                                                        if (textView3 != null) {
                                                                                            ...
                                                                                            if (textView4 != null) {
                                                                                                ...
                                                                                                if (viewPagerAllResponse != null) {
                                                                                                    return new ActivityMusicWideBinding((RelativeLayout) rootView, constraintLayout, constraintLayout2, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, constraintLayout3, rhythmLedView2, rhythmLedView22, rhythmLedView23, constraintLayout4, linearLayout, relativeLayout, constraintLayout5, seekBar, textView, textView2, textView3, textView4, viewPagerAllResponse);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
