...
public final class ViewTemplateOne12Binding implements ViewBinding {
    ...
    public static ViewTemplateOne12Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewTemplateOne12Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.view_template_one_1_2, parent, false);
        if (attachToParent) {
    ...
    public static ViewTemplateOne12Binding bind(View rootView) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (constraintLayout != null) {
                                                ...
                                                if (constraintLayout2 != null) {
                                                    return new ViewTemplateOne12Binding((ConstraintLayout) rootView, imageView, objectarxItem, objectarxItem2, findChildViewById, findChildViewById2, textView, relativeLayout, textView2, relativeLayout2, constraintLayout, constraintLayout2);
                                                }
                                            }
                                        }
                                    }
