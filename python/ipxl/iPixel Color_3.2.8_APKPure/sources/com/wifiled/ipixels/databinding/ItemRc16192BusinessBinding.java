...
public final class ItemRc16192BusinessBinding implements ViewBinding {
    ...
    private ItemRc16192BusinessBinding(ConstraintLayout rootView, ImageView ivAnimEdit, ImageView ivAnimPreview, ImageView ivAnimSelect, ImageView ivNum, ObjectarxItem objectarxItem, RelativeLayout relayoutChannelText, RelativeLayout rlImageOutsideFrame) {
    ...
    public static ItemRc16192BusinessBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemRc16192BusinessBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_rc_16192_business, parent, false);
        if (attachToParent) {
    ...
    public static ItemRc16192BusinessBinding bind(View rootView) {
                        ...
                        if (objectarxItem != null) {
                            ...
                            if (relativeLayout != null) {
                                ...
                                if (relativeLayout2 != null) {
                                    return new ItemRc16192BusinessBinding((ConstraintLayout) rootView, imageView, imageView2, imageView3, imageView4, objectarxItem, relativeLayout, relativeLayout2);
                                }
                            }
                        }
                    }
