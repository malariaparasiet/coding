...
public final class ItemRcBinding implements ViewBinding {
    ...
    private ItemRcBinding(ConstraintLayout rootView, ImageView ivAnimPreview, ImageView ivAnimSelect, RelativeLayout rlImageOutsideFrame, TextView tvIndex) {
    ...
    public static ItemRcBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemRcBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_rc, parent, false);
        if (attachToParent) {
    ...
    public static ItemRcBinding bind(View rootView) {
        ...
        if (imageView != null) {
            ...
            if (imageView2 != null) {
                ...
                if (relativeLayout != null) {
                    ...
                    if (textView != null) {
                        return new ItemRcBinding((ConstraintLayout) rootView, imageView, imageView2, relativeLayout, textView);
                    }
                }
            }
        }
