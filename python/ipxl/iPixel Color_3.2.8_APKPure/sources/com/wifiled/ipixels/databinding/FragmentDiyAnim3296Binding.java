...
public final class FragmentDiyAnim3296Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim3296Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim3296Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_3296, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim3296Binding bind(View rootView) {
