...
public final class ItemImageBinding implements ViewBinding {
    ...
    private ItemImageBinding(ConstraintLayout rootView, ImageView ivPreview, RelativeLayout rlImageOutsideFrame) {
    ...
    public static ItemImageBinding bind(View rootView) {
        ...
        if (imageView != null) {
            ...
            if (relativeLayout != null) {
                return new ItemImageBinding((ConstraintLayout) rootView, imageView, relativeLayout);
            }
        }
