...
public final class ItemChannelList32128Binding implements ViewBinding {
    ...
    private ItemChannelList32128Binding(ConstraintLayout rootView, ImageView ivChannelFix, ImageView ivChannelImagGifItem, ImageView ivChlDel, ImageView ivChlSel, ImageView leftEyesGif, ObjectarxItem objectarxItem, RelativeLayout relayoutChannelText, ImageView rightEyesGif, RelativeLayout rl128bg, LedView rlChannelTextBg, TextView tvNum) {
    ...
    public static ItemChannelList32128Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemChannelList32128Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_channel_list_32128, parent, false);
        if (attachToParent) {
    ...
    public static ItemChannelList32128Binding bind(View rootView) {
                                    ...
                                    if (imageView6 != null) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (ledView != null) {
                                                ...
                                                if (textView != null) {
                                                    return new ItemChannelList32128Binding((ConstraintLayout) rootView, imageView, imageView2, imageView3, imageView4, imageView5, objectarxItem, relativeLayout, imageView6, relativeLayout2, ledView, textView);
                                                }
                                            }
                                        }
                                    }
