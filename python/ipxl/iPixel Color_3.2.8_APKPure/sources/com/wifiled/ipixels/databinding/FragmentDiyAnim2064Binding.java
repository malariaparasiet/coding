...
public final class FragmentDiyAnim2064Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim2064Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim2064Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_2064, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim2064Binding bind(View rootView) {
