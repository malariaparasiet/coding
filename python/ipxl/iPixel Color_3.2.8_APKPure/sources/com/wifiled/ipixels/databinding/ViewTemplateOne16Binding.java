...
public final class ViewTemplateOne16Binding implements ViewBinding {
    ...
    public static ViewTemplateOne16Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewTemplateOne16Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.view_template_one_1_6, parent, false);
        if (attachToParent) {
    ...
    public static ViewTemplateOne16Binding bind(View rootView) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (constraintLayout != null) {
                                                ...
                                                if (constraintLayout2 != null) {
                                                    return new ViewTemplateOne16Binding((ConstraintLayout) rootView, imageView, objectarxItem, objectarxItem2, findChildViewById, findChildViewById2, textView, relativeLayout, textView2, relativeLayout2, constraintLayout, constraintLayout2);
                                                }
                                            }
                                        }
                                    }
