...
public final class ViewTemplateThree12Binding implements ViewBinding {
    ...
    private ViewTemplateThree12Binding(ConstraintLayout rootView, View tem3BorderView1, ImageView tem3Iv1, TextView tem3Tv1, RelativeLayout tem3Tv1Text, ObjectarxItem tem3Tv1TextRl, ConstraintLayout template) {
    ...
    public static ViewTemplateThree12Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ViewTemplateThree12Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.view_template_three_1_2, parent, false);
        if (attachToParent) {
    ...
    public static ViewTemplateThree12Binding bind(View rootView) {
                    ...
                    if (relativeLayout != null) {
                        ...
                        if (objectarxItem != null) {
                            ...
                            if (constraintLayout != null) {
                                return new ViewTemplateThree12Binding((ConstraintLayout) rootView, findChildViewById, imageView, textView, relativeLayout, objectarxItem, constraintLayout);
                            }
                        }
                    }
                }
