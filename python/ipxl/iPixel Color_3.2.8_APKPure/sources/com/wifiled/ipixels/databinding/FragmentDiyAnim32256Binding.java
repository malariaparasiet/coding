...
public final class FragmentDiyAnim32256Binding implements ViewBinding {
    ...
    public static FragmentDiyAnim32256Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentDiyAnim32256Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.fragment_diy_anim_32256, parent, false);
        if (attachToParent) {
    ...
    public static FragmentDiyAnim32256Binding bind(View rootView) {
