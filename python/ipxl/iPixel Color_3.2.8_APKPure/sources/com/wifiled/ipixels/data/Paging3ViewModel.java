...
public final class Paging3ViewModel extends ViewModel {
    ...
    public final Flow<PagingData<Record>> getPagingData(final String type, final String label, final String categoryName, final int width, final int height, final String language, final String filter_tags) {
        ...
        return CachedPagingDataKt.cachedIn(new Pager(new PagingConfig(i, i, false, i, 0, 0, 48, null), null, new Function0() { // from class: com.wifiled.ipixels.data.Paging3ViewModel$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                androidx.paging.PagingSource pagingData$lambda$0;
                pagingData$lambda$0 = Paging3ViewModel.getPagingData$lambda$0(type, label, categoryName, width, height, language, filter_tags);
    ...
    public static final androidx.paging.PagingSource getPagingData$lambda$0(String str, String str2, String str3, int i, int i2, String str4, String str5) {
        return new PagingSource(str, str2, str3, i, i2, str4, str5);
    }
}
