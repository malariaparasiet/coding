...
@DebugMetadata(c = "com.wifiled.ipixels.ui.diy.DiyAnimActivity$pickMultipleMedia$1$2$1", f = "DiyAnimActivity.kt", i = {}, l = {871}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class DiyAnimActivity$pickMultipleMedia$1$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    DiyAnimActivity$pickMultipleMedia$1$2$1(DiyAnimActivity diyAnimActivity, Ref.ObjectRef<String> objectRef, Ref.IntRef intRef, Continuation<? super DiyAnimActivity$pickMultipleMedia$1$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new DiyAnimActivity$pickMultipleMedia$1$2$1(this.this$0, this.$filePath, this.$iIndex, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((DiyAnimActivity$pickMultipleMedia$1$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            UtilsExtensionKt.showLoadingDialog$default((Activity) diyAnimActivity, false, diyAnimActivity.getString(R.string.msg_loading) + "...", false, 5, (Object) null);
            this.label = 1;
        ...
        DiyAnimActivity diyAnimActivity2 = this.this$0;
        ...
        for (Bitmap bitmap : GifCore.decodeGif(element)) {
            ...
            intRef.element = i2 + 1;
            diyAnimActivity2.addFrame(bitmap, i2);
        }
        if (!list.isEmpty()) {
            imageView = diyAnimActivity2.iv_git_preview;
            if (imageView == null) {
            ...
            recyclerView = diyAnimActivity2.rl_diy_anim_add_item;
    ...
    @DebugMetadata(c = "com.wifiled.ipixels.ui.diy.DiyAnimActivity$pickMultipleMedia$1$2$1$1", f = "DiyAnimActivity.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.wifiled.ipixels.ui.diy.DiyAnimActivity$pickMultipleMedia$1$2$1$1, reason: invalid class name */
