...
@DebugMetadata(c = "com.wifiled.ipixels.ui.adapter.EyeAnimAdapter$onBindViewHolder$1$1$1$1", f = "EyeAnimAdapter.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class EyeAnimAdapter$onBindViewHolder$1$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ViewTarget<ImageView, Drawable>>, Object> {
    ...
    EyeAnimAdapter$onBindViewHolder$1$1$1$1(EyeAnimAdapter.ViewHolder viewHolder, File file, Ref.IntRef intRef, Continuation<? super EyeAnimAdapter$onBindViewHolder$1$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new EyeAnimAdapter$onBindViewHolder$1$1$1$1(this.$holder, this.$it, this.$placeholder, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ViewTarget<ImageView, Drawable>> continuation) {
        return ((EyeAnimAdapter$onBindViewHolder$1$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
