...
@Metadata(d1 = {"\u0000/\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0012\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\u0005*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H\u0016J\b\u0010\u0004\u001a\u00020\u0003H\u0016J\"\u0010\u0005\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u000bH\u0016J\u0010\u0010\f\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u0007H\u0016J\u001a\u0010\r\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u00072\u0006\u0010\u000e\u001a\u00020\tH\u0016J\u0012\u0010\u000f\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007H\u0016J\u0012\u0010\u0010\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007H\u0016J\"\u0010\u0011\u001a\u00020\u00032\b\u0010\u0006\u001a\u0004\u0018\u00010\u00072\u0006\u0010\u0012\u001a\u00020\u000b2\u0006\u0010\u0013\u001a\u00020\u0014H\u0016J \u0010\u0015\u001a\u00020\u00032\u0006\u0010\u0016\u001a\u00020\u00072\u0006\u0010\u0017\u001a\u00020\t2\u0006\u0010\u0018\u001a\u00020\tH\u0016¨\u0006\u0019"}, d2 = {"com/wifiled/ipixels/ui/dialog/ConnectDialog$bleCallback2$1", "Lcom/wifiled/ipixels/core/BleManager2$BleCallback;", "onScanStart", "", "onScanEnd", "onScan", "device", "Lcom/wifiled/blelibrary/ble/model/BleDevice;", "rssi", "", "scanRecord", "", "onConnectionChanged", "onConnectionException", "errorCode", "onConnectionTimeout", "onReady", "onChanged", "data", "characteristic", "Landroid/bluetooth/BluetoothGattCharacteristic;", "onMtuChanged", "device1", "mtu", NotificationCompat.CATEGORY_STATUS, "app_googleRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ConnectDialog$bleCallback2$1 extends BleManager2.BleCallback {
    ...
    ConnectDialog$bleCallback2$1(ConnectDialog connectDialog) {
    ...
    public void onConnectionChanged(BleDevice device) {
        ...
        Intrinsics.checkNotNullParameter(device, "device");
        LogUtils.vTag("ruis", "onConnectionChanged2" + device.getBleName());
        ...
        if (device.isConnected()) {
            ...
            i = this.this$0.mPrevState2;
            if (i != 1) {
                z = this.this$0.mIsManualOperation2;
                if (!z) {
                    this.this$0.hideLoadingDialog(1000L);
                }
            }
            this.this$0.mIsManualOperation2 = false;
        ...
        i2 = this.this$0.mPrevState2;
        i3 = this.this$0.mNewState2;
        if (i2 != i3) {
            ConnectDialog connectDialog2 = this.this$0;
            i4 = connectDialog2.mNewState2;
            connectDialog2.mPrevState2 = i4;
        }
    }

    @Override // com.wifiled.ipixels.core.BleManager2.BleCallback
    public void onConnectionException(BleDevice device, int errorCode) {
        LogUtils.vTag("ruis", "onConnectionException2" + errorCode + "}");
        ...
        ApiService.uploadCrash$default(request, packageName, appMetaData, null, null, null, null, versionName, valueOf, encodeToString, 60, null).enqueue(new Callback<CloudRes>() { // from class: com.wifiled.ipixels.ui.dialog.ConnectDialog$bleCallback2$1$onConnectionException$1
    ...
    public void onConnectionTimeout(BleDevice device) {
        ...
        UtilsExtensionKt.ui(new Function0() { // from class: com.wifiled.ipixels.ui.dialog.ConnectDialog$bleCallback2$1$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit onConnectionTimeout$lambda$0;
                onConnectionTimeout$lambda$0 = ConnectDialog$bleCallback2$1.onConnectionTimeout$lambda$0(ConnectDialog.this);
    ...
    public void onChanged(BleDevice device, byte[] data, BluetoothGattCharacteristic characteristic) {
        ...
        LogUtils.vTag("ruis", "onChanged2");
    }

    @Override // com.wifiled.ipixels.core.BleManager2.BleCallback
    public void onMtuChanged(BleDevice device1, int mtu, int status) {
        Intrinsics.checkNotNullParameter(device1, "device1");
        LogUtils.vTag("ruis", "onMtuChanged2");
        final ConnectDialog connectDialog = this.this$0;
        UtilsExtensionKt.ui(new Function0() { // from class: com.wifiled.ipixels.ui.dialog.ConnectDialog$bleCallback2$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit onMtuChanged$lambda$1;
                onMtuChanged$lambda$1 = ConnectDialog$bleCallback2$1.onMtuChanged$lambda$1(ConnectDialog.this);
