...
public final /* data */ class Video {
    ...
    public static /* synthetic */ Video copy$default(Video video, int i, String str, String str2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = video.id;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i3;
        String str3 = str2;
        return video.copy(i, str, str3, i2, i5);
    }
    ...
    public final Video copy(int id, String url, String bgr_url, int ledType, int bright) {
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(bgr_url, "bgr_url");
        return new Video(id, url, bgr_url, ledType, bright);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.id == video.id && Intrinsics.areEqual(this.url, video.url) && Intrinsics.areEqual(this.bgr_url, video.bgr_url) && this.ledType == video.ledType && this.bright == video.bright;
    }
    ...
    public String toString() {
        return "Video(id=" + this.id + ", url=" + this.url + ", bgr_url=" + this.bgr_url + ", ledType=" + this.ledType + ", bright=" + this.bright + ")";
    }

    public Video(int i, String url, String bgr_url, int i2, int i3) {
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(bgr_url, "bgr_url");
        this.id = i;
        this.url = url;
    ...
    public /* synthetic */ Video(int i, String str, String str2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
