...
public class HttpsUtils {
    public static X509TrustManager UnSafeTrustManager = new X509TrustManager() { // from class: com.wifiled.baselib.uicode.net.HttpsUtils.1
    ...
    public static HostnameVerifier UnSafeHostnameVerifier = new HostnameVerifier() { // from class: com.wifiled.baselib.uicode.net.HttpsUtils.2
