...
@DebugMetadata(c = "com.wifiled.baselib.uicode.viewmodel.BaseViewModel$ioNetLaunch$job$1", f = "BaseViewModel.kt", i = {}, l = {Opcodes.FRETURN}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class BaseViewModel$ioNetLaunch$job$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BaseViewModel$ioNetLaunch$job$1(this.$block, this.$success, this.$failed, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BaseViewModel$ioNetLaunch$job$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
