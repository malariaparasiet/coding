...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filter$1", f = "Deprecated.kt", i = {0, 1, 1, 2}, l = {Command.CMD_OTA_EXIT_UPDATE_MODE, Command.CMD_OTA_SEND_FIRMWARE_UPDATE_BLOCK, Command.CMD_OTA_SEND_FIRMWARE_UPDATE_BLOCK}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", "e", "$this$produce"}, s = {"L$0", "L$0", "L$2", "L$0"})
