...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m5103trySendImplMj0NB7M = conflatedBufferedChannel.m5103trySendImplMj0NB7M(e, true);
        if (m5103trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m5088exceptionOrNullimpl(m5103trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m5103trySendImplMj0NB7M = conflatedBufferedChannel.m5103trySendImplMj0NB7M(e, true);
        if (!(m5103trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2747trySendJP2dKIU(E element) {
        return m5103trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m5103trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m5102trySendDropLatestMj0NB7M(element, isSendOp) : m5078trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m5102trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2747trySendJP2dKIU = super.mo2747trySendJP2dKIU(element);
        if (ChannelResult.m5094isSuccessimpl(mo2747trySendJP2dKIU) || ChannelResult.m5092isClosedimpl(mo2747trySendJP2dKIU)) {
            return mo2747trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo2747trySendJP2dKIU = mo2747trySendJP2dKIU(element);
        if (!(mo2747trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo2747trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m5088exceptionOrNullimpl(mo2747trySendJP2dKIU);
