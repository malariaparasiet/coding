...
public interface SendChannel<E> {
    ...
    Object mo2747trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m5094isSuccessimpl(mo2747trySendJP2dKIU)) {
                return true;
            }
            Throwable m5088exceptionOrNullimpl = ChannelResult.m5088exceptionOrNullimpl(mo2747trySendJP2dKIU);
