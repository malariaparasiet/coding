...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            symbol = BroadcastChannelKt.NO_ELEMENT;
            if (obj2 != symbol) {
                subscriberConflated.mo2747trySendJP2dKIU(getValue());
            }
    ...
    */
    ...
    public Object mo2747trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo2747trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo2747trySendJP2dKIU(element);
            }
    ...
    public String toString() {
        ...
        Object obj = this.lastConflatedElement;
        symbol = BroadcastChannelKt.NO_ELEMENT;
        return sb.append(obj != symbol ? "CONFLATED_ELEMENT=" + this.lastConflatedElement + "; " : "").append("BROADCAST=<").append(super.toString()).append(">; SUBSCRIBERS=").append(CollectionsKt.joinToString$default(this.subscribers, ";", SimpleComparison.LESS_THAN_OPERATION, SimpleComparison.GREATER_THAN_OPERATION, 0, null, null, 56, null)).toString();
    }
}
