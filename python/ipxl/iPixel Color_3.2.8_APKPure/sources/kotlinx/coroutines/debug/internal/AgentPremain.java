...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m3567constructorimpl = Result.m3567constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m3567constructorimpl = Result.m3567constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m3573isFailureimpl(m3567constructorimpl) ? null : m3567constructorimpl);
