...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo5137scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m5057delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m5058toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m5058toDelayMillisLRDsOJo(long j) {
        boolean m4941isPositiveimpl = Duration.m4941isPositiveimpl(j);
        if (m4941isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m4925getInWholeMillisecondsimpl(Duration.m4943plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m4941isPositiveimpl) {
