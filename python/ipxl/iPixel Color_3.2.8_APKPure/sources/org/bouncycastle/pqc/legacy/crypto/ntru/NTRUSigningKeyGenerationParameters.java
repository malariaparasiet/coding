...
public class NTRUSigningKeyGenerationParameters extends KeyGenerationParameters implements Cloneable {
    ...
    public static final NTRUSigningKeyGenerationParameters APR2011_439 = new NTRUSigningKeyGenerationParameters(439, 2048, Opcodes.I2C, 1, 1, 0.165d, 490.0d, 280.0d, false, true, 0, new SHA256Digest());
    ...
    public static final NTRUSigningKeyGenerationParameters TEST157 = new NTRUSigningKeyGenerationParameters(Opcodes.IFGT, 256, 29, 1, 1, 0.38d, 200.0d, 80.0d, false, false, 0, new SHA256Digest());
    public static final NTRUSigningKeyGenerationParameters TEST157_PROD = new NTRUSigningKeyGenerationParameters(Opcodes.IFGT, 256, 5, 5, 8, 1, 1, 0.38d, 200.0d, 80.0d, false, false, 0, new SHA256Digest());
    ...
    public int hashCode() {
        ...
        return (((((((((((i6 * 31) + ((int) (doubleToLongBits6 ^ (doubleToLongBits6 >>> 32)))) * 31) + this.polyType) * 31) + (this.primeCheck ? 1231 : 1237)) * 31) + this.q) * 31) + this.signFailTolerance) * 31) + (this.sparse ? 1231 : 1237);
    }
    ...
    public String toString() {
        ...
        if (this.polyType == 0) {
            append = new StringBuilder(" polyType=SIMPLE d=");
            i = this.d;
        } else {
            append = new StringBuilder(" polyType=PRODUCT d1=").append(this.d1).append(" d2=").append(this.d2).append(" d3=");
            i = this.d3;
        }
