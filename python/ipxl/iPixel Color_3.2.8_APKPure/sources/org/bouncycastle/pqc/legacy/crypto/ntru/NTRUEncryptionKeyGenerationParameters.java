...
public class NTRUEncryptionKeyGenerationParameters extends KeyGenerationParameters implements Cloneable {
    ...
    public static final NTRUEncryptionKeyGenerationParameters APR2011_439 = new NTRUEncryptionKeyGenerationParameters(439, 2048, Opcodes.I2C, Opcodes.IXOR, 128, 9, 32, 9, true, new byte[]{0, 7, 101}, true, false, new SHA256Digest());
    public static final NTRUEncryptionKeyGenerationParameters APR2011_439_FAST = new NTRUEncryptionKeyGenerationParameters(439, 2048, 9, 8, 5, Opcodes.IXOR, 128, 9, 32, 9, true, new byte[]{0, 7, 101}, true, true, new SHA256Digest());
    public static final NTRUEncryptionKeyGenerationParameters APR2011_743 = new NTRUEncryptionKeyGenerationParameters(743, 2048, 248, 220, 256, 10, 27, 14, true, new byte[]{0, 7, JSONB.Constants.BC_STR_ASCII_FIX_32}, false, false, new SHA512Digest());
    public static final NTRUEncryptionKeyGenerationParameters APR2011_743_FAST = new NTRUEncryptionKeyGenerationParameters(743, 2048, 11, 11, 15, 220, 256, 10, 27, 14, true, new byte[]{0, 7, JSONB.Constants.BC_STR_ASCII_FIX_32}, false, true, new SHA512Digest());
    ...
    public NTRUEncryptionKeyGenerationParameters(InputStream inputStream) throws IOException {
        ...
        if (!"SHA-512".equals(readUTF)) {
            sHA256Digest = "SHA-256".equals(readUTF) ? new SHA256Digest() : sHA256Digest;
            init();
        }
    ...
    public String toString() {
        ...
        if (this.polyType == 0) {
            append = new StringBuilder(" polyType=SIMPLE df=");
            i = this.df;
        } else {
            append = new StringBuilder(" polyType=PRODUCT df1=").append(this.df1).append(" df2=").append(this.df2).append(" df3=");
            i = this.df3;
        }
