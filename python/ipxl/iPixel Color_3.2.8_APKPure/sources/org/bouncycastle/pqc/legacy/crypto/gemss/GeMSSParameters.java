...
public class GeMSSParameters {
    ...
    static {
        GeMSSParameters geMSSParameters = new GeMSSParameters("gemss128", 128, Opcodes.FRETURN, 12, 12, 4, InputDeviceCompat.SOURCE_DPAD, 9, 0);
        ...
        GeMSSParameters geMSSParameters4 = new GeMSSParameters("bluegemss128", 128, Opcodes.DRETURN, 14, 13, 4, Opcodes.LOR, 7, 0);
        bluegemss128 = geMSSParameters4;
        GeMSSParameters geMSSParameters5 = new GeMSSParameters("bluegemss192", 192, 265, 23, 22, 4, Opcodes.LOR, 7, 0);
        bluegemss192 = geMSSParameters5;
        GeMSSParameters geMSSParameters6 = new GeMSSParameters("bluegemss256", 256, 358, 32, 34, 4, Opcodes.LOR, 7, 0);
        bluegemss256 = geMSSParameters6;
        GeMSSParameters geMSSParameters7 = new GeMSSParameters("redgemss128", 128, Opcodes.RETURN, 15, 15, 4, 17, 4, 0);
        ...
        GeMSSParameters geMSSParameters10 = new GeMSSParameters("whitegemss128", 128, Opcodes.DRETURN, 12, 12, 3, InputDeviceCompat.SOURCE_DPAD, 9, 0);
        ...
        GeMSSParameters geMSSParameters13 = new GeMSSParameters("cyangemss128", 128, Opcodes.RETURN, 13, 14, 3, Opcodes.LOR, 7, 0);
        cyangemss128 = geMSSParameters13;
        GeMSSParameters geMSSParameters14 = new GeMSSParameters("cyangemss192", 192, 270, 22, 23, 3, Opcodes.LOR, 7, 0);
        cyangemss192 = geMSSParameters14;
        GeMSSParameters geMSSParameters15 = new GeMSSParameters("cyangemss256", 256, 364, 32, 31, 3, Opcodes.LOR, 7, 0);
        cyangemss256 = geMSSParameters15;
        GeMSSParameters geMSSParameters16 = new GeMSSParameters("magentagemss128", 128, Opcodes.GETSTATIC, 15, 15, 3, 17, 4, 0);
        ...
        GeMSSParameters geMSSParameters19 = new GeMSSParameters("fgemss128", 128, 266, 11, 10, 1, Opcodes.LOR, 7, 0);
        ...
        GeMSSParameters geMSSParameters22 = new GeMSSParameters("dualmodems128", 128, 266, 11, 10, 1, Opcodes.LOR, 7, 0);
        dualmodems128 = geMSSParameters22;
        GeMSSParameters geMSSParameters23 = new GeMSSParameters("dualmodems192", 192, TypedValues.CycleType.TYPE_VISIBILITY, 18, 18, 1, Opcodes.LOR, 7, 0);
        dualmodems192 = geMSSParameters23;
        GeMSSParameters geMSSParameters24 = new GeMSSParameters("dualmodems256", 256, 544, 32, 32, 1, Opcodes.LOR, 7, 0);
        dualmodems256 = geMSSParameters24;
        Integer valueOf = Integers.valueOf(257);
        gemss_128 = valueOf;
        Integer valueOf2 = Integers.valueOf(PlayerService.SEEK_CHANGE);
        gemss_192 = valueOf2;
        Integer valueOf3 = Integers.valueOf(PlayerService.MODE_CHANGE);
        gemss_256 = valueOf3;
        ...
        Integer valueOf9 = Integers.valueOf(MusicManager.MSG_SCANNED_MUSIC);
        ...
        Integer valueOf23 = Integers.valueOf(BleStates.CharaUuidNull);
