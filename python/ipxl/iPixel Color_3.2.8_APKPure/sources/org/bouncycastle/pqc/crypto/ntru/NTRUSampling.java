...
class NTRUSampling {
    ...
    public HPSPolynomial sampleFixedType(byte[] bArr) {
        ...
        while (true) {
            ...
            iArr[i5 + 1] = ((bArr[(i4 * 3) + 15] & JSONB.Constants.BC_INT64_SHORT_MIN) >> 4) + ((bArr[i6 + 4] & UByte.MAX_VALUE) << 4) + ((bArr[i6 + 5] & UByte.MAX_VALUE) << 12) + ((bArr[i6 + 6] & UByte.MAX_VALUE) << 20) + ((bArr[i6 + 7] & UByte.MAX_VALUE) << 28);
            int i7 = ((bArr[(i4 * 7) + 15] & JSONB.Constants.BC_INT32_NUM_MIN) >> 2) + ((bArr[i6 + 8] & UByte.MAX_VALUE) << 6) + ((bArr[i6 + 9] & UByte.MAX_VALUE) << 14) + ((bArr[i6 + 10] & UByte.MAX_VALUE) << 22);
            byte b = bArr[i6 + 11];
        ...
        if (i3 > i8) {
            ...
            iArr[i8 + 1] = ((bArr[(i * 3) + 15] & JSONB.Constants.BC_INT64_SHORT_MIN) >> 4) + ((bArr[i9 + 4] & UByte.MAX_VALUE) << 4) + ((bArr[i9 + 5] & UByte.MAX_VALUE) << 12) + ((bArr[i9 + 6] & UByte.MAX_VALUE) << 20) + ((bArr[i9 + 7] & UByte.MAX_VALUE) << 28);
        }
        int i10 = 0;
        while (true) {
            i2 = weight / 2;
