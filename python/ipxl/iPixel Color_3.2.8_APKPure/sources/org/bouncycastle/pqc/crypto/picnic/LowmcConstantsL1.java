...
public class LowmcConstantsL1 extends LowmcConstants {
    LowmcConstantsL1() {
        try {
            ...
            this.LMatrix_full = new KMatrices(4, Opcodes.LOR, 5, this.linearMatrices_full);
            this.LMatrix_inv = new KMatrices(4, Opcodes.LOR, 5, this.linearMatrices_inv);
            this.KMatrix_full = new KMatrices(5, Opcodes.LOR, 5, this.keyMatrices_full);
            this.KMatrix_inv = new KMatrices(1, Opcodes.LOR, 5, this.keyMatrices_inv);
