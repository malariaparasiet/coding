...
public class NTRULPRimeParameters implements KEMParameters {
    ...
    private final int w;
    public static final NTRULPRimeParameters ntrulpr653 = new NTRULPRimeParameters("ntrulpr653", 653, 4621, 252, 289, 2175, 113, BleStates.ConnectFailed, 290, 865, 897, 1125, 32);
    public static final NTRULPRimeParameters ntrulpr761 = new NTRULPRimeParameters("ntrulpr761", 761, 4591, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 292, 2156, 114, BleStates.NotAvailable, 287, PointerIconCompat.TYPE_CROSSHAIR, 1039, 1294, 32);
