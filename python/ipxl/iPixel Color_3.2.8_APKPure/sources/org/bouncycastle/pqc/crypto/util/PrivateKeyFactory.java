...
public class PrivateKeyFactory {
    ...
    public static AsymmetricKeyParameter createKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_alg_ml_kem_512) || algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_alg_ml_kem_768) || algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_alg_ml_kem_1024)) {
            ASN1Primitive parsePrimitiveString = parsePrimitiveString(privateKeyInfo.getPrivateKey(), 64);
            MLKEMParameters mlkemParamsLookup = Utils.mlkemParamsLookup(algorithm);
            MLKEMPublicKeyParameters publicKeyParams = privateKeyInfo.getPublicKeyData() != null ? PublicKeyFactory.MLKEMConverter.getPublicKeyParams(mlkemParamsLookup, privateKeyInfo.getPublicKeyData()) : null;
            if (parsePrimitiveString instanceof ASN1OctetString) {
                return new MLKEMPrivateKeyParameters(mlkemParamsLookup, ((ASN1OctetString) parsePrimitiveString).getOctets(), publicKeyParams);
            }
            if (!(parsePrimitiveString instanceof ASN1Sequence)) {
                throw new IllegalArgumentException("invalid " + mlkemParamsLookup.getName() + " private key");
            }
            ASN1Sequence aSN1Sequence = (ASN1Sequence) parsePrimitiveString;
            byte[] octets2 = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(0)).getOctets();
            byte[] octets3 = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(1)).getOctets();
            MLKEMPrivateKeyParameters mLKEMPrivateKeyParameters = new MLKEMPrivateKeyParameters(mlkemParamsLookup, octets2, publicKeyParams);
        ...
        if (algorithm.on(BCObjectIdentifiers.pqc_kem_sntruprime)) {
            ...
            return new SNTRUPrimePrivateKeyParameters(Utils.sntruprimeParamsLookup(algorithm), ASN1OctetString.getInstance(aSN1Sequence3.getObjectAt(0)).getOctets(), ASN1OctetString.getInstance(aSN1Sequence3.getObjectAt(1)).getOctets(), ASN1OctetString.getInstance(aSN1Sequence3.getObjectAt(2)).getOctets(), ASN1OctetString.getInstance(aSN1Sequence3.getObjectAt(3)).getOctets(), ASN1OctetString.getInstance(aSN1Sequence3.getObjectAt(4)).getOctets());
        }
        if (Utils.mldsaParams.containsKey(algorithm)) {
            ASN1Primitive parsePrimitiveString2 = parsePrimitiveString(privateKeyInfo.getPrivateKey(), 32);
            MLDSAParameters mldsaParamsLookup = Utils.mldsaParamsLookup(algorithm);
            MLDSAPublicKeyParameters publicKeyParams2 = privateKeyInfo.getPublicKeyData() != null ? PublicKeyFactory.MLDSAConverter.getPublicKeyParams(mldsaParamsLookup, privateKeyInfo.getPublicKeyData()) : null;
            if (parsePrimitiveString2 instanceof ASN1OctetString) {
                return new MLDSAPrivateKeyParameters(mldsaParamsLookup, ((ASN1OctetString) parsePrimitiveString2).getOctets(), publicKeyParams2);
            }
            if (!(parsePrimitiveString2 instanceof ASN1Sequence)) {
                throw new IllegalArgumentException("invalid " + mldsaParamsLookup.getName() + " private key");
            }
            ASN1Sequence aSN1Sequence4 = (ASN1Sequence) parsePrimitiveString2;
            byte[] octets4 = ASN1OctetString.getInstance(aSN1Sequence4.getObjectAt(0)).getOctets();
            byte[] octets5 = ASN1OctetString.getInstance(aSN1Sequence4.getObjectAt(1)).getOctets();
            MLDSAPrivateKeyParameters mLDSAPrivateKeyParameters = new MLDSAPrivateKeyParameters(mldsaParamsLookup, octets4, publicKeyParams2);
        ...
        if (algorithm.equals((ASN1Primitive) BCObjectIdentifiers.dilithium2) || algorithm.equals((ASN1Primitive) BCObjectIdentifiers.dilithium3) || algorithm.equals((ASN1Primitive) BCObjectIdentifiers.dilithium5)) {
            ...
            if (!(parsePrivateKey2 instanceof ASN1Sequence)) {
                ...
                byte[] octets6 = ASN1OctetString.getInstance(parsePrivateKey2).getOctets();
                return privateKeyInfo.getPublicKeyData() != null ? new DilithiumPrivateKeyParameters(dilithiumParamsLookup, octets6, PublicKeyFactory.DilithiumConverter.getPublicKeyParams(dilithiumParamsLookup, privateKeyInfo.getPublicKeyData())) : new DilithiumPrivateKeyParameters(dilithiumParamsLookup, octets6, null);
            }
            ASN1Sequence aSN1Sequence5 = ASN1Sequence.getInstance(parsePrivateKey2);
            int intValueExact = ASN1Integer.getInstance(aSN1Sequence5.getObjectAt(0)).intValueExact();
            if (intValueExact != 0) {
        ...
        if (algorithm.on(BCObjectIdentifiers.pqc_kem_bike)) {
            byte[] octets7 = ASN1OctetString.getInstance(privateKeyInfo.parsePrivateKey()).getOctets();
            BIKEParameters bikeParamsLookup = Utils.bikeParamsLookup(algorithm);
            return new BIKEPrivateKeyParameters(bikeParamsLookup, Arrays.copyOfRange(octets7, 0, bikeParamsLookup.getRByte()), Arrays.copyOfRange(octets7, bikeParamsLookup.getRByte(), bikeParamsLookup.getRByte() * 2), Arrays.copyOfRange(octets7, bikeParamsLookup.getRByte() * 2, octets7.length));
        }
    ...
    private static ASN1OctetString parseOctetString(ASN1OctetString aSN1OctetString, int i) throws IOException {
        ASN1OctetString parseOctetData;
        byte[] octets = aSN1OctetString.getOctets();
        return (octets.length == i || (parseOctetData = Utils.parseOctetData(octets)) == null) ? aSN1OctetString : ASN1OctetString.getInstance(parseOctetData);
    }

    private static ASN1Primitive parsePrimitiveString(ASN1OctetString aSN1OctetString, int i) throws IOException {
        byte[] octets = aSN1OctetString.getOctets();
        if (octets.length == i) {
            return aSN1OctetString;
        }
        ASN1Primitive parseData = Utils.parseData(octets);
        return parseData instanceof ASN1OctetString ? ASN1OctetString.getInstance(parseData) : parseData instanceof ASN1Sequence ? ASN1Sequence.getInstance(parseData) : aSN1OctetString;
    }
}
