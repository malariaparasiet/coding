...
public abstract class Polynomial {
    ...
    public void s3FromBytes(byte[] bArr) {
        ...
        for (int i = 0; i < this.params.packDegree() / 5; i++) {
            ...
            sArr[i2 + 1] = (short) ((i3 * Opcodes.LOOKUPSWITCH) >>> 9);
            sArr[i2 + 2] = (short) ((i3 * 57) >>> 9);
            sArr[i2 + 3] = (short) ((i3 * 19) >>> 9);
            sArr[i2 + 4] = (short) ((i3 * ComposerKt.providerValuesKey) >>> 14);
        }
        if (this.params.packDegree() > (this.params.packDegree() / 5) * 5) {
            ...
            while (true) {
                ...
                this.coeffs[i5] = b2;
                b2 = (byte) (((b2 & UByte.MAX_VALUE) * Opcodes.LOOKUPSWITCH) >> 9);
                i4++;
            }
        }
    ...
    public void s3ToBytes(byte[] bArr, int i) {
        int packDegree = this.params.packDegree();
        int i2 = packDegree - 5;
        int i3 = 0;
        while (i3 <= i2) {
            short[] sArr = this.coeffs;
            int i4 = sArr[i3] & 255;
            int i5 = (sArr[i3 + 1] & 255) * 3;
            int i6 = (sArr[i3 + 2] & 255) * 9;
            bArr[i] = (byte) (i4 + i5 + i6 + ((sArr[i3 + 3] & 255) * 27) + ((sArr[i3 + 4] & 255) * 81));
            i3 += 5;
            i++;
        }
        if (i3 >= packDegree) {
