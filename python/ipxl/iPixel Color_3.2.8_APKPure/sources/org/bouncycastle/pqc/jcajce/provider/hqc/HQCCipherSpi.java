...
class HQCCipherSpi extends CipherSpi {
    ...
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws InvalidKeyException, NoSuchAlgorithmException {
        ...
        try {
            ...
            KeyParameter keyParameter = new KeyParameter(WrapUtil.trimSecret(this.kemParameterSpec.getKeyAlgorithmName(), extractSecret));
    ...
    protected byte[] engineWrap(Key key) throws IllegalBlockSizeException, InvalidKeyException {
        ...
        try {
            ...
            Wrapper wrapper = WrapUtil.getWrapper(this.kemParameterSpec.getKeyAlgorithmName());
            wrapper.init(true, new KeyParameter(WrapUtil.trimSecret(this.kemParameterSpec.getKeyAlgorithmName(), generateEncapsulated.getSecret())));
