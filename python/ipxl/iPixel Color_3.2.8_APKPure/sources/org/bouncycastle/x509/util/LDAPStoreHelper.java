...
public class LDAPStoreHelper {
    ...
    */
    ...
    private String parseDN(String str, String str2) {
        int indexOf = Strings.toLowerCase(str).indexOf(Strings.toLowerCase(str2) + SimpleComparison.EQUAL_TO_OPERATION);
        if (indexOf == -1) {
            return "";
        }
    ...
    private List search(String[] strArr, String str, String[] strArr2) throws StoreException {
        ...
        if (strArr == null) {
            ...
            for (String str4 : strArr) {
                str3 = str3 + "(" + str4 + SimpleComparison.EQUAL_TO_OPERATION + str + ")";
            }
            str2 = "(|" + str3 + ")";
        }
        String str5 = "";
