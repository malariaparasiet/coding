...
public abstract class Nat {
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + (iArr[i2 + i5] & M) + (iArr2[i3 + i5] & M) + (M & iArr3[r7]);
            iArr3[i4 + i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = j + (iArr[i2 + i4] & M) + (M & iArr2[r7]);
            iArr2[i3 + i4] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int i4) {
        long j = i4 & M;
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + (iArr[i2 + i5] & M) + (iArr2[r6] & M);
            iArr2[i3 + i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addToEachOther(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = j + (iArr[r3] & M) + (M & iArr2[r8]);
            int i5 = (int) j2;
            iArr[i2 + i4] = i5;
            iArr2[i3 + i4] = i5;
            j = j2 >>> 32;
    ...
    public static int cadd(int i, int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            long j3 = j2 + (iArr[i3] & M) + (iArr2[i3] & j);
            iArr3[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int caddTo(int i, int i2, int[] iArr, int[] iArr2) {
        ...
        long j2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
            long j3 = j2 + (iArr2[i3] & M) + (iArr[i3] & j);
            iArr2[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int csub(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        long j2 = 0;
        for (int i6 = 0; i6 < i; i6++) {
            long j3 = j2 + ((iArr[i3 + i6] & M) - (iArr2[i4 + i6] & j));
            iArr3[i5 + i6] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static int lessThan(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            j = (j + ((iArr[i2 + i4] & M) - (M & iArr2[i3 + i4]))) >> 32;
        }
        return (int) j;
    }
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        int i5 = 0;
        do {
            long j4 = j3 + ((iArr[i5] & M) * j) + ((iArr2[i5] & M) * j2) + (iArr3[r10] & M);
            iArr3[i4 + i5] = (int) j4;
            j3 = j4 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        while (i5 < i) {
            int i7 = i;
            int[] iArr4 = iArr3;
            long mulWordAddTo = j + (mulWordAddTo(i7, iArr[i2 + i5], r5, r6, iArr4, i6) & M) + (iArr4[r9] & M);
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i2 < i) {
            int i3 = i;
            int[] iArr4 = iArr3;
            long mulWordAddTo = j + (mulWordAddTo(i3, iArr[i2], r4, 0, iArr4, i2) & M) + (iArr4[r10] & M);
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = j2 + ((iArr[i3 + i5] & M) * j) + (iArr2[r8] & M);
            iArr2[i4 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        long j3 = 0;
        for (i4 = 1; i4 < i; i4++) {
            long squareWordAddTo = j3 + (squareWordAddTo(iArr, i2, i4, iArr2, i3) & M) + (iArr2[i9] & M);
            int i10 = i9 + 1;
            iArr2[i9] = (int) squareWordAddTo;
            long j4 = (squareWordAddTo >>> 32) + (iArr2[i10] & M);
            i9 += 2;
            iArr2[i10] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        int i8 = 2;
        for (i2 = 1; i2 < i; i2++) {
            long squareWordAddTo = j3 + (squareWordAddTo(iArr, i2, iArr2) & M) + (iArr2[i8] & M);
            int i9 = i8 + 1;
            iArr2[i8] = (int) squareWordAddTo;
            long j4 = (squareWordAddTo >>> 32) + (iArr2[i9] & M);
            i8 += 2;
            iArr2[i9] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static int squareWordAddTo(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        ...
        int i5 = i3;
        do {
            long j3 = j2 + ((iArr[i + i4] & M) * j) + (iArr2[r11] & M);
            iArr2[i2 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
            i4++;
    ...
    public static int squareWordAddTo(int[] iArr, int i, int[] iArr2) {
        ...
        int i2 = 0;
        do {
            long j3 = j2 + ((iArr[i2] & M) * j) + (iArr2[r9] & M);
            iArr2[i + i2] = (int) j3;
            j2 = j3 >>> 32;
            i2++;
        } while (i2 < i);
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        long j = 0;
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + (((iArr3[r3] & M) - (iArr[i2 + i5] & M)) - (M & iArr2[i3 + i5]));
            iArr3[i4 + i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = j + ((iArr2[r3] & M) - (M & iArr[i2 + i4]));
            iArr2[i3 + i4] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
