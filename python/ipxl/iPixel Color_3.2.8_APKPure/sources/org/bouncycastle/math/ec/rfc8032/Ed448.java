...
public abstract class Ed448 {
    ...
    private static final byte[] DOM4_PREFIX = {83, JSONB.Constants.BC_STR_ASCII_FIX_32, 103, 69, 100, 52, 52, JSONB.Constants.BC_INT32_BYTE_ZERO};
    ...
    public static void precompute() {
        ...
        synchronized (PRECOMP_LOCK) {
            if (PRECOMP_BASE_COMB == null) {
                ...
                PRECOMP_BASE_COMB = F.createTable(Opcodes.IF_ICMPNE);
                int i13 = 0;
    ...
    private static void scalarMultStraus225Var(int[] iArr, int[] iArr2, PointAffine pointAffine, int[] iArr3, PointAffine pointAffine2, PointProjective pointProjective) {
        ...
        int i2 = Command.CMD_OTA_GET_DEVICE_UPDATE_FILE_INFO_OFFSET;
        byte[] bArr2 = new byte[Command.CMD_OTA_GET_DEVICE_UPDATE_FILE_INFO_OFFSET];
        byte[] bArr3 = new byte[Command.CMD_OTA_GET_DEVICE_UPDATE_FILE_INFO_OFFSET];
        ...
        while (i >= 0) {
            ...
            byte b2 = bArr[i + Command.CMD_OTA_GET_DEVICE_UPDATE_FILE_INFO_OFFSET];
            if (b2 != 0) {
