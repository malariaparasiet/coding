...
class LongArray implements Cloneable {
    ...
    private static int bitLength(long j) {
        ...
        if (i4 == 0) {
            ...
            int i6 = i3 >>> 24;
            i = i6 == 0 ? bitLengths[i4] + JSONB.Constants.BC_INT32_NUM_16 : bitLengths[i6] + 24;
        }
        return i2 + i;
    }
