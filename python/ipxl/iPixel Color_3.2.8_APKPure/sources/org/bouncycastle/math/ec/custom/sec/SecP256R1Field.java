...
public class SecP256R1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        iArr2[0] = (int) j18;
        long j19 = (j18 >> 32) + ((((iArr[1] & M) + j11) - j14) - j16);
        iArr2[1] = (int) j19;
        long j20 = (j19 >> 32) + (((iArr[2] & M) + j12) - j15);
        iArr2[2] = (int) j20;
        long j21 = (j20 >> 32) + ((((iArr[3] & M) + (j13 << 1)) + j17) - j16);
        iArr2[3] = (int) j21;
        long j22 = (j21 >> 32) + ((((iArr[4] & M) + (j14 << 1)) + j7) - j11);
        iArr2[4] = (int) j22;
        long j23 = (j22 >> 32) + (((iArr[5] & M) + (j15 << 1)) - j12);
        iArr2[5] = (int) j23;
        long j24 = (j23 >> 32) + (iArr[6] & M) + (j16 << 1) + j17;
        iArr2[6] = (int) j24;
        long j25 = (j24 >> 32) + (((((iArr[7] & M) + (j8 << 1)) + j9) - j12) - j14);
        iArr2[7] = (int) j25;
