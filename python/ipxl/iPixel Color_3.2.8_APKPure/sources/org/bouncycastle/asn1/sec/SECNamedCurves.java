...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.18
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(Opcodes.LXOR, 2, 3, 8, SECNamedCurves.fromHex("07A11B09A76B562144418FF3FF8C2570B8"), SECNamedCurves.fromHex("0217C05610884B63B9C6C7291678F9D341"), SECNamedCurves.fromHex("0400000000000000023123953A9464B54D"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect131r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.19
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(Opcodes.LXOR, 2, 3, 8, SECNamedCurves.fromHex("03E5A88919D7CAFCBF415F07C2176573B2"), SECNamedCurves.fromHex("04B8266A46C55657AC734CE38F018F2192"), SECNamedCurves.fromHex("0400000000000000016954A233049BA98F"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.20
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(Opcodes.IF_ICMPGT, 3, 6, 7, BigInteger.valueOf(1L), BigInteger.valueOf(1L), SECNamedCurves.fromHex("04000000000000000000020108A2E0CC0D99F8A5EF"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.21
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(Opcodes.IF_ICMPGT, 3, 6, 7, SECNamedCurves.fromHex("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2"), SECNamedCurves.fromHex("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9"), SECNamedCurves.fromHex("03FFFFFFFFFFFFFFFFFFFF48AAB689C29CA710279B"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.22
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(Opcodes.IF_ICMPGT, 3, 6, 7, BigInteger.valueOf(1L), SECNamedCurves.fromHex("020A601907B8C953CA1481EB10512F78744A3205FD"), SECNamedCurves.fromHex("040000000000000000000292FE77E70C12A4234C33"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.23
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(Opcodes.INSTANCEOF, 15, SECNamedCurves.fromHex("0017858FEB7A98975169E171F77B4087DE098AC8A911DF7B01"), SECNamedCurves.fromHex("00FDFB49BFE6C3A89FACADAA7A1E5BBC7CC1C2E5D831478814"), SECNamedCurves.fromHex("01000000000000000000000000C7F34A778F443ACC920EBA49"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.27
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(239, Opcodes.IFLE, ECConstants.ZERO, BigInteger.valueOf(1L), SECNamedCurves.fromHex("2000000000000000000000000000005A79FEC67CB6E91F1C1DA800E478A5"), BigInteger.valueOf(4L)));
        }
