...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1TaggedObjectParser {
    ...
    public static ASN1TaggedObject getOptional(ASN1Object aSN1Object, int i) {
        ASN1TaggedObject optional = getOptional(aSN1Object);
        if (optional == null || !optional.hasTagClass(i)) {
            return null;
        }
        return optional;
    }

    public static ASN1TaggedObject getOptional(ASN1Object aSN1Object, int i, int i2) {
        ASN1TaggedObject optional = getOptional(aSN1Object);
        if (optional == null || !optional.hasTag(i, i2)) {
            return null;
        }
        return optional;
    }
