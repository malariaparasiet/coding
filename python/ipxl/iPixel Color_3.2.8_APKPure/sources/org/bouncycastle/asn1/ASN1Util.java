...
public abstract class ASN1Util {
    ...
    public static ASN1Object getExplicitBaseObject(ASN1TaggedObject aSN1TaggedObject, int i) {
        return checkTagClass(aSN1TaggedObject, i).getExplicitBaseObject();
    }
    ...
    public static Object getInstanceChoiceBaseObject(ASN1TaggedObject aSN1TaggedObject, boolean z, String str) {
        if (!z) {
    ...
    public static Object getTaggedChoiceBaseObject(ASN1TaggedObject aSN1TaggedObject, boolean z, String str) {
        if (!z) {
            throw new IllegalArgumentException("Implicit tagging cannot be used with untagged choice type " + str + " (X.680 30.6, 30.8).");
        }
        if (aSN1TaggedObject != null) {
    ...
    public static ASN1Object tryGetExplicitBaseObject(ASN1TaggedObject aSN1TaggedObject, int i) {
        if (aSN1TaggedObject.hasTagClass(i)) {
            return aSN1TaggedObject.getExplicitBaseObject();
        }
        return null;
