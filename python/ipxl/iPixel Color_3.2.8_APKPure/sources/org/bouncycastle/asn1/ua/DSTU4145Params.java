...
public class DSTU4145Params extends ASN1Object {
    private static final byte[] DEFAULT_DKE = {JSONB.Constants.BC_LOCAL_DATE, -42, -21, 69, -15, 60, 112, -126, ByteCompanionObject.MIN_VALUE, JSONB.Constants.BC_INT64_SHORT_ZERO, -106, JSONB.Constants.BC_STR_UTF16, 35, 31, 94, JSONB.Constants.BC_TIMESTAMP_MINUTES, -10, 88, -21, JSONB.Constants.BC_ARRAY, JSONB.Constants.BC_INT64_SHORT_MIN, 55, 41, 29, JSONB.Constants.BC_INT32_BYTE_ZERO, -39, 107, JSONB.Constants.BC_INT32_NUM_MIN, 37, -54, JSONB.Constants.BC_STR_ASCII_FIX_5, 23, -8, -23, 114, 13, -58, 21, JSONB.Constants.BC_DOUBLE_LONG, 58, 40, -105, 95, 11, -63, -34, JSONB.Constants.BC_ARRAY_FIX_MAX, 100, JSONB.Constants.BC_INT32_BYTE_ZERO, JSONB.Constants.BC_DOUBLE, 100, -22, 44, 23, -97, JSONB.Constants.BC_INT64_BYTE_ZERO, 18, 62, JSONB.Constants.BC_STR_ASCII_FIX_36, JSONB.Constants.BC_DECIMAL_LONG, -6, -59, JSONB.Constants.BC_STR_ASCII, 4};
    private byte[] dke;
