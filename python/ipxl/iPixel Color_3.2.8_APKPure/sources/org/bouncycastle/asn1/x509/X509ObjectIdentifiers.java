...
public interface X509ObjectIdentifiers {
    ...
    static {
        ...
        commonName = intern.branch(ExifInterface.GPS_MEASUREMENT_3D).intern();
        ...
        id_alg_noSignature = branch.branch(ExifInterface.GPS_MEASUREMENT_2D);
        id_pda = aSN1ObjectIdentifier.branch("9");
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("48");
        id_ad = branch2;
        ASN1ObjectIdentifier intern2 = branch2.branch(ExifInterface.GPS_MEASUREMENT_2D).intern();
