...
public final class Camellia {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia128_cbc, str + "$CBC128");
            configurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia192_cbc, str + "$CBC192");
            configurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia256_cbc, str + "$CBC256");
            ...
            configurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia128_wrap, str + "$Wrap128");
            configurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia192_wrap, str + "$Wrap192");
            configurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia256_wrap, str + "$Wrap256");
