...
public final class AES {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_ECB, str + "$ECB128");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_ECB, str + "$ECB192");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_ECB, str + "$ECB256");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_CBC, str + "$CBC128");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_CBC, str + "$CBC192");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_CBC, str + "$CBC256");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_OFB, str + "$OFB128");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_OFB, str + "$OFB192");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_OFB, str + "$OFB256");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_CFB, str + "$CFB128");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_CFB, str + "$CFB192");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_CFB, str + "$CFB256");
            ...
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_wrap, str + "$Wrap128");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_wrap, str + "$Wrap192");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_wrap, str + "$Wrap256");
            ...
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_wrap_pad, str + "$WrapPad128");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_wrap_pad, str + "$WrapPad192");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_wrap_pad, str + "$WrapPad256");
            ...
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_CCM, str + "$CCM128");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_CCM, str + "$CCM192");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_CCM, str + "$CCM256");
            ...
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_GCM, str + "$GCM128");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_GCM, str + "$GCM192");
            configurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_GCM, str + "$GCM256");
            ...
            configurableProvider.addAlgorithm("Mac." + NISTObjectIdentifiers.id_aes128_CCM.getId(), str + "$AESCCMMAC128");
            configurableProvider.addAlgorithm("Mac." + NISTObjectIdentifiers.id_aes192_CCM.getId(), str + "$AESCCMMAC192");
            configurableProvider.addAlgorithm("Mac." + NISTObjectIdentifiers.id_aes256_CCM.getId(), str + "$AESCCMMAC256");
