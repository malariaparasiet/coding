...
public class GOST3410ParametersGenerator {
    ...
    private int procedure_A(int i, int i2, BigInteger[] bigIntegerArr, int i3) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                int i18 = i12 + 1;
                BigInteger add = bigInteger8.pow(iArr[i12] - i4).divide(bigIntegerArr4[i18]).add(bigInteger8.pow(iArr[i12] - i4).multiply(bigInteger7).divide(bigIntegerArr4[i18].multiply(bigInteger8.pow(i14 * 16))));
                ...
                while (true) {
                    ...
                    long j = i19;
                    BigInteger multiply = bigIntegerArr4[i18].multiply(bigInteger10.add(BigInteger.valueOf(j)));
                    ...
                    if (add2.compareTo(bigInteger12.pow(iArr[i12])) != 1) {
                        if (bigInteger12.modPow(bigIntegerArr4[i18].multiply(bigInteger10.add(BigInteger.valueOf(j))), bigIntegerArr4[i12]).compareTo(bigInteger11) == 0 && bigInteger12.modPow(bigInteger10.add(BigInteger.valueOf(j)), bigIntegerArr4[i12]).compareTo(bigInteger11) != 0) {
                            break;
                        }
                        i19 = i20 + 2;
    ...
    private void procedure_B(int i, int i2, BigInteger[] bigIntegerArr) {
        ...
        while (true) {
            ...
            while (i8 < 64) {
                int i9 = i8 + 1;
                bigIntegerArr3[i9] = bigIntegerArr3[i8].multiply(bigInteger2).add(bigInteger).mod(TWO.pow(16));
                i8 = i9;
            }
            BigInteger bigInteger5 = new BigInteger("0");
            for (int i10 = i7; i10 < 64; i10++) {
                bigInteger5 = bigInteger5.add(bigIntegerArr3[i10].multiply(TWO.pow(i10 * 16)));
            }
            bigIntegerArr3[i7] = bigIntegerArr3[64];
            ...
            while (true) {
                ...
                if (bigInteger10.modPow(bigInteger3.multiply(bigInteger4).multiply(bigInteger8.add(BigInteger.valueOf(j))), add2).compareTo(bigInteger9) == 0 && bigInteger10.modPow(bigInteger3.multiply(bigInteger8.add(BigInteger.valueOf(j))), add2).compareTo(bigInteger9) != 0) {
                    bigIntegerArr[i4] = add2;
                    bigIntegerArr[i12] = bigInteger3;
                    return;
                } else {
                    i11 += 2;
                    i7 = i4;
    ...
    private void procedure_Bb(long j, long j2, BigInteger[] bigIntegerArr) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                int i8 = i;
                if (bigInteger9.modPow(bigInteger3.multiply(bigInteger4).multiply(add.add(BigInteger.valueOf(j5))), add2).compareTo(bigInteger8) == 0 && bigInteger9.modPow(bigInteger3.multiply(add.add(BigInteger.valueOf(j5))), add2).compareTo(bigInteger8) != 0) {
                    bigIntegerArr[i2] = add2;
