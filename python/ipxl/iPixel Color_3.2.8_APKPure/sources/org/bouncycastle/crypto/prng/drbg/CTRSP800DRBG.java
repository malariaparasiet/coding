...
public class CTRSP800DRBG implements SP80090DRBG {
    ...
    private void padKey(byte[] bArr, int i, byte[] bArr2, int i2) {
        bArr2[i2] = (byte) (bArr[i] & JL_Constant.PREFIX_FLAG_FIRST);
        int i3 = i + 1;
        ...
        int i6 = bArr[i5] << 5;
        int i7 = i + 3;
        bArr2[i2 + 3] = (byte) (i6 | ((bArr[i7] & JSONB.Constants.BC_INT32_NUM_MIN) >>> 3));
        int i8 = bArr[i7] << 4;
        int i9 = i + 4;
        bArr2[i2 + 4] = (byte) (i8 | ((bArr[i9] & 224) >>> 4));
        int i10 = bArr[i9] << 3;
        int i11 = i + 5;
        bArr2[i2 + 5] = (byte) (i10 | ((bArr[i11] & JSONB.Constants.BC_INT64_SHORT_MIN) >>> 5));
        int i12 = i + 6;
        ...
        while (i2 <= i13) {
            byte b = bArr2[i2];
            bArr2[i2] = (byte) (((((b >> 7) ^ ((((((b >> 1) ^ (b >> 2)) ^ (b >> 3)) ^ (b >> 4)) ^ (b >> 5)) ^ (b >> 6))) ^ 1) & 1) | (b & JL_Constant.PREFIX_FLAG_FIRST));
            i2++;
        }
    }
