...
public class FPEFF3_1Engine extends FPEEngine {
    ...
    protected int decryptBlock(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (this.fpeParameters.getRadix() > 256) {
            decryptFF3_1 = toByteArray(SP80038G.decryptFF3_1w(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), toShortArray(bArr), i, i2 / 2));
            i4 = i2;
        } else {
            i4 = i2;
            decryptFF3_1 = SP80038G.decryptFF3_1(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), bArr, i, i4);
        }
    ...
    protected int encryptBlock(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        byte[] encryptFF3_1;
        if (this.fpeParameters.getRadix() > 256) {
            encryptFF3_1 = toByteArray(SP80038G.encryptFF3_1w(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), toShortArray(bArr), i, i2 / 2));
            i4 = i2;
        } else {
            i4 = i2;
            encryptFF3_1 = SP80038G.encryptFF3_1(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), bArr, i, i4);
        }
