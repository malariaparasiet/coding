...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", HintConstants.AUTOFILL_HINT_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup, newInstance, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", HintConstants.AUTOFILL_HINT_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup, newInstance, secureRandom);
