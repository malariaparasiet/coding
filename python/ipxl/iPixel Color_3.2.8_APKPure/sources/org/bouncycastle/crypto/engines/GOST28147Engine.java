...
public class GOST28147Engine implements BlockCipher {
    ...
    public GOST28147Engine() {
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(getAlgorithmName(), Opcodes.GETSTATIC));
    }
    ...
    private int GOST28147_mainStep(int i, int i2) {
        int i3 = i2 + i;
        byte[] bArr = this.S;
        int i4 = bArr[i3 & 15] + (bArr[((i3 >> 4) & 15) + 16] << 4) + (bArr[((i3 >> 8) & 15) + 32] << 8) + (bArr[((i3 >> 12) & 15) + 48] << 12) + (bArr[((i3 >> 16) & 15) + 64] << JSONB.Constants.BC_INT32_NUM_16) + (bArr[((i3 >> 20) & 15) + 80] << 20) + (bArr[((i3 >> 24) & 15) + 96] << 24) + (bArr[((i3 >> 28) & 15) + 112] << 28);
        return (i4 << 11) | (i4 >>> 21);
    }
    ...
    private int bytesToint(byte[] bArr, int i) {
        return ((bArr[i + 3] << 24) & ViewCompat.MEASURED_STATE_MASK) + ((bArr[i + 2] << JSONB.Constants.BC_INT32_NUM_16) & 16711680) + ((bArr[i + 1] << 8) & 65280) + (bArr[i] & UByte.MAX_VALUE);
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(getAlgorithmName(), Opcodes.GETSTATIC, cipherParameters, Utils.getPurpose(z)));
    }
