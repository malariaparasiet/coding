...
public class ISO9796d2Signer implements SignerWithRecovery {
    ...
    public byte[] generateSignature() throws CryptoException {
        ...
        if (i8 > 0) {
            for (int i9 = i8; i9 != 0; i9--) {
                this.block[i9] = JSONB.Constants.BC_BIGINT;
            }
    ...
    public void updateWithRecoveredMessage(byte[] bArr) throws InvalidCipherTextException {
        ...
        if (((processBlock[0] & JSONB.Constants.BC_INT64_SHORT_MIN) ^ 64) != 0) {
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (((processBlock[0] & JSONB.Constants.BC_INT64_SHORT_MIN) ^ 64) == 0 && ((processBlock[processBlock.length - 1] & 15) ^ 12) == 0) {
            if (((processBlock[processBlock.length - 1] & UByte.MAX_VALUE) ^ 188) == 0) {
                i = 1;
            } else {
                i = 2;
