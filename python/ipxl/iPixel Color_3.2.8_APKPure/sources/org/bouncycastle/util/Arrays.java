...
public final class Arrays {
    ...
    public static boolean segmentsOverlap(int i, int i2, int i3, int i4) {
    ...
    public static void validateRange(byte[] bArr, int i, int i2) {
        ...
        if (((bArr.length - i) | i | (i2 - i) | (bArr.length - i2)) < 0) {
            throw new IndexOutOfBoundsException("buf.length: " + bArr.length + ", from: " + i + ", to: " + i2);
        }
    }

    public static void validateSegment(byte[] bArr, int i, int i2) {
        if (bArr == null) {
            throw new NullPointerException("'buf' cannot be null");
        }
