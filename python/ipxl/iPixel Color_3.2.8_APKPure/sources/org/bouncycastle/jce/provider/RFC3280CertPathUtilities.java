    ...
    */
    private static void checkCRL(org.bouncycastle.jcajce.PKIXCertRevocationCheckerParameters r19, org.bouncycastle.asn1.x509.DistributionPoint r20, org.bouncycastle.jcajce.PKIXExtendedParameters r21, java.util.Date r22, java.util.Date r23, java.security.cert.X509Certificate r24, java.security.cert.X509Certificate r25, java.security.PublicKey r26, org.bouncycastle.jce.provider.CertStatus r27, org.bouncycastle.jce.provider.ReasonsMask r28, java.util.List r29, org.bouncycastle.jcajce.util.JcaJceHelper r30) throws org.bouncycastle.jce.provider.AnnotatedException, org.bouncycastle.jce.provider.RecoverableCertPathValidatorException {
        ...
        L25:
            ...
            if (r2 != 0) goto Ld1
            java.lang.Object r2 = r12.next()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lcc
            java.security.cert.X509CRL r2 = (java.security.cert.X509CRL) r2     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lcc
            org.bouncycastle.jce.provider.ReasonsMask r4 = processCRLD(r2, r1)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lcc
            boolean r5 = r4.hasNewReasons(r11)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lcc
            if (r5 != 0) goto L4a
            goto L25
        L4a:
            r5 = r26
            ...
            r13 = r4
            r4 = r25
            java.util.Set r15 = processCRLF(r2, r3, r4, r5, r6, r7, r8)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            java.security.PublicKey r4 = processCRLG(r2, r15)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lcc
            boolean r5 = r6.isUseDeltasEnabled()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lcc
            if (r5 == 0) goto L74
            java.util.List r5 = r6.getCertStores()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lcc
            java.util.List r7 = r6.getCRLStores()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lcc
            r8 = r30
            java.util.Set r5 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getDeltaCRLs(r9, r2, r5, r7, r8)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            java.security.cert.X509CRL r4 = processCRLH(r5, r4)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            goto L77
        L74:
            r8 = r30
            r4 = 0
        L77:
            int r5 = r6.getValidityModel()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            r7 = 1
            if (r5 == r7) goto L9b
            java.util.Date r5 = r3.getNotAfter()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            long r15 = r5.getTime()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            java.util.Date r5 = r2.getThisUpdate()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            long r17 = r5.getTime()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            int r5 = (r15 > r17 ? 1 : (r15 == r17 ? 0 : -1))
            if (r5 < 0) goto L93
            goto L9b
        L93:
            org.bouncycastle.jce.provider.AnnotatedException r0 = new org.bouncycastle.jce.provider.AnnotatedException     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            java.lang.String r2 = "No valid CRL for current time found."
            r0.<init>(r2)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            throw r0     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
        L9b:
            processCRLB1(r1, r3, r2)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            processCRLB2(r1, r3, r2)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            processCRLC(r4, r2, r6)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            processCRLI(r9, r4, r3, r10, r6)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            processCRLJ(r9, r2, r3, r10)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            int r5 = r10.getCertStatus()     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            r15 = 8
            if (r5 != r15) goto Lb7
            r5 = 11
            r10.setCertStatus(r5)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
        Lb7:
            r11.addReasons(r13)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            java.lang.String r5 = "CRL contains unsupported critical extensions."
            org.bouncycastle.jce.provider.CertPathValidatorUtilities.checkCRLCriticalExtensions(r2, r5)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
            if (r4 == 0) goto Lc6
            java.lang.String r2 = "Delta CRL contains unsupported critical extensions."
            org.bouncycastle.jce.provider.CertPathValidatorUtilities.checkCRLCriticalExtensions(r4, r2)     // Catch: org.bouncycastle.jce.provider.AnnotatedException -> Lc9
        Lc6:
            r14 = r7
            goto L25
        Lc9:
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected static void checkCRLs(org.bouncycastle.jcajce.PKIXCertRevocationCheckerParameters r19, org.bouncycastle.jcajce.PKIXExtendedParameters r20, java.util.Date r21, java.util.Date r22, java.security.cert.X509Certificate r23, java.security.cert.X509Certificate r24, java.security.PublicKey r25, java.util.List r26, org.bouncycastle.jcajce.util.JcaJceHelper r27) throws org.bouncycastle.jce.provider.AnnotatedException, org.bouncycastle.jce.provider.RecoverableCertPathValidatorException {
        /*
    ...
    */
    ...
    protected static PKIXPolicyNode processCertD(CertPath certPath, int i, Set set, PKIXPolicyNode pKIXPolicyNode, List[] listArr, int i2, boolean z) throws CertPathValidatorException {
        ...
        try {
            ...
            PKIXPolicyNode removeChildlessPolicyNodes = CertPathValidatorUtilities.removeChildlessPolicyNodes(pKIXPolicyNode, listArr, i3);
